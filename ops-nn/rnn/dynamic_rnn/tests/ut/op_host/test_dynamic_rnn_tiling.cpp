...
/*!
 * \file test_dynamic_rnn_tiling.cpp
 * \brief
 */
#include <fstream>
#include <iostream>
...
struct DynamicRNNTilingTestParam {
  string case_name;
  string compile_info;
...
class DynamicRNNTilingRunTime2 : public testing::TestWithParam<DynamicRNNTilingTestParam> {
 protected:
  static void SetUpTestCase() {
    std::cout << "DynamicRNNTilingTestParam SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "DynamicRNNTilingTestParam TearDown" << std::endl;
  }
};

class DynamicRNNTilingRunTime22 : public testing::TestWithParam<DynamicRNNTilingTestParam> {
 protected:
  static void SetUpTestCase() {
    std::cout << "DynamicRNNTilingTestParam SetUp" << std::endl;
  }
...
void RNNTest(DynamicRNNTilingTestParam param) {
  ...
  gert::StorageShape w_shape = {param.w_shape, param.w_shape};
  gert::StorageShape b_shape = {param.b_shape, param.b_shape};
  gert::StorageShape seq_shape = {param.y_shape, param.y_shape};
  ...
  for (size_t i = 0; i < output_shapes.size(); ++i) {
    ...
    std::cout << "myPring \n { ";
    bool is_first = true;
    for (const auto& elem : param.x_shape) {
        if (!is_first) {
            std::cout << ", ";
        }
        std::cout << elem;
  ...
  optiling::DynamicRnnCompileInfo compile_info;
...
TEST_P(DynamicRNNTilingRunTime2, general_cases) {
  DynamicRNNTilingTestParam param = GetParam();
  RNNTest(param);
}

TEST_P(DynamicRNNTilingRunTime22, general_cases2) {
  DynamicRNNTilingTestParam param = GetParam();
  RNNTest(param);
}

static DynamicRNNTilingTestParam general_cases_params[] = {
  {"DynamicRNN_fuzz_test1", R"({"_pattern": "MatMul", "format_a": "FRACTAL_NZ", "format_b": "FRACTAL_NZ", "dynamic_mode":"dynamic_mknb",
        "hardware_info": {"BT_SIZE": 0, "load3d_constraints": "1", "Intrinsic_fix_pipe_l0c2out": true, "Intrinsic_data_move_l12ub": true, "Intrinsic_data_move_l0c2ub": true, "Intrinsic_data_move_out2l1_nd2nz": false, "UB_SIZE": 262144, "L2_SIZE": 33554432, "L1_SIZE": 1048576, "L0A_SIZE": 65536, "L0B_SIZE": 65536, "L0C_SIZE": 262144, "CORE_NUM": 24},
        ...
        "_attr_vars":{"133124":[]}})",
    {2, 16, 16}, {32, 64}, {64}, {1, 16, 16}, {2, 16, 16},
    ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND,
    ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT,
    "LSTM", "UNIDIRECTIONAL", 1, false, 1.0, -1.0, 0, true, "tanh", 0.0, "ifjo", true,
    true, false,
    true, true,
...
static DynamicRNNTilingTestParam general_cases_params2[] = {
    {"DynamicRNN_fuzz_test2", R"({"_pattern": "MatMul", "format_a": "FRACTAL_NZ", "format_b": "FRACTAL_NZ", "dynamic_mode":"dynamic_mknb",
        "hardware_info": {"BT_SIZE": 0, "load3d_constraints": "1", "Intrinsic_fix_pipe_l0c2out": false, "Intrinsic_data_move_l12ub": true, "Intrinsic_data_move_l0c2ub": true, "Intrinsic_data_move_out2l1_nd2nz": false, "UB_SIZE": 262144, "L2_SIZE": 33554432, "L1_SIZE": 1048576, "L0A_SIZE": 65536, "L0B_SIZE": 65536, "L0C_SIZE": 262144, "CORE_NUM": 24},
        "repo_seeds": {}, "repo_range": {}, "attrs":{"transpose_a": false, "transpose_b": false},
        "binary_attrs":{"bias_flag":false,"nd_flag":false, "split_k_flag":false, "zero_flag":false, "weight_nz":false, "l2_size":33554432},"binary_mode_flag":true,
        "block_dim": {"133124": 32}, "correct_range_flag":null,
        "_vars":{"133124":["m", "k", "n", "batch_single_core", "m_single_core", "n_single_core", "batch_dim",
        ...
        "n_dim", "m_dim", "m_al1", "n_bl1", "cub_n1", "m_l0", "k_l0", "n_ub_l0_time", "kal0_factor", "kbl0_factor",
        "kal1_factor", "kbl1_factor", "kal1_16", "kbl1_16", "kl1_times", "batch"]}, "_normal_vars":{"133124":[]},
        "_attr_vars":{"133124":[]}, "vars":{"tune_shape_list":[[2,256,3]]}})",
        {2, 16, 16}, {32, 64}, {64}, {1, 16, 16}, {2, 16, 16},
        ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND,
        ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT,
        "LSTM", "UNIDIRECTIONAL", 1, false, 1.0, -1.0, 0, true, "tanh", 0.0, "ifjo", true,
...
INSTANTIATE_TEST_CASE_P(DynamicRNN, DynamicRNNTilingRunTime2, testing::ValuesIn(general_cases_params));
INSTANTIATE_TEST_CASE_P(DynamicRNN, DynamicRNNTilingRunTime22, testing::ValuesIn(general_cases_params2));
