...
#include "../op_kernel/celu_v2_tiling_data.h"
#include "../op_kernel/celu_v2_tiling_key.h"
...
static ge::graphStatus CeluV2TilingFunc(gert::TilingContext* context)
{
    ...
    if (totalIdx <= 0) {
        ...
        memset_s(tiling, sizeof(CeluV2TilingData), 0, sizeof(CeluV2TilingData));
