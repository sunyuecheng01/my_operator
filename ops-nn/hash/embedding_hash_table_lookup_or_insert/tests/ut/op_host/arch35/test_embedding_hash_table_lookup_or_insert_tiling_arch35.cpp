...
#include "../../../../op_host/arch35/embedding_hash_table_lookup_or_insert_tiling_arch35.h"
...
class HashTableLookupOrInsertTiling : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "HashTableLookupOrInsertTiling SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "HashTableLookupOrInsertTiling TearDown" << std::endl;
  }
};
...
TEST_F(HashTableLookupOrInsertTiling, hashtable_lookup_or_insert_tiling_001) {
  ...
  struct LookupOrInsertCompileInfo {
    uint32_t maxThread = 1024;
    uint32_t coreNum = 64;
  };
  LookupOrInsertCompileInfo compile_info;

  std::string op_type("EmbeddingHashTableLookupOrInsert");
  ...
  auto holder = gert::TilingContextFaker()
                    .SetOpType("EmbeddingHashTableLookupOrInsert")
                    .NodeIoNum(2, 1)
                    .IrInstanceNum({1, 1})
