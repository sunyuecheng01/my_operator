...
/*!
 * \file test_embedding_hash_table_applyadamw_tiling.cpp
 * \brief
 */
...
#include "../../../../op_host/arch35/embedding_hash_table_apply_adam_w_tiling_arch35.h"
...
TEST_F(EmbeddingHashTableApplyAdamWTiling, EmbeddingHashTableApplyAdamW_FP32_Tiling_Test1)
{
    ...
    // EXPECT_EQ(to_string<int32_t>(tilingData->GetData(), tilingData->GetDataSize()), "16 4 32 2 1 1 32 0 16 0 1 0 ");
    // dlog_setlevel(0, 3, 0);
}
...
TEST_F(EmbeddingHashTableApplyAdamWTiling, EmbeddingHashTableApplyAdamW_FP32_Tiling_Test2)
{
    ...
    gert::StorageShape v_shape = {{2, 2, 32}, {2, 2, 32}};
    gert::StorageShape beta1_power_shape = {{1}, {1}};
    gert::StorageShape beta2_power_shape = {{1}, {1}};
    gert::StorageShape lr_shape = {{1}, {1}};
    gert::StorageShape weight_decay_shape = {{1}, {1}};
    ...
    gert::StorageShape beta2_shape = {{1}, {1}};
    gert::StorageShape epsilon_shape = {{1}, {1}};
    gert::StorageShape grad_shape = {{2, 2, 32}, {2, 2, 32}};
    gert::StorageShape max_grad_norm_shape = {{2, 2, 32}, {2, 2, 32}};
