...
/*!
 * \file test_embedding_hash_table_import_tiling.cpp
 * \brief
 */
...
class EmbeddingHashTableImportTiling : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "EmbeddingHashTableImportTiling SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "EmbeddingHashTableImportTiling TearDown" << std::endl;
  }
};
...
TEST_F(EmbeddingHashTableImportTiling, embedding_hash_table_import_tiling_001) {
  ...
  gert::StorageShape bucket_sizes_shape = {{2,}, {2,}};
  ...
  // compile info
  optiling::EmbeddingHashTableImportCompileInfo compile_info;

  std::string op_type("EmbeddingHashTableImport");
  ...
  auto holder = gert::TilingContextFaker()
                    .SetOpType("EmbeddingHashTableImport")
                    .NodeIoNum(7, 1)
  ...
  auto block_dims = tiling_context->GetBlockDim();
  auto tiling_data_result = TilingData2Str(tiling_context->GetRawTilingData());
  std::cout << "tiling_data_result: " << tiling_data_result << std::endl;
}