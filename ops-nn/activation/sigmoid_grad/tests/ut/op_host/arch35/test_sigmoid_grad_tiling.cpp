...
/*!
 * \file test_sigmoid_grad_tiling.cpp
 * \brief
 */
...
#include "../../../../op_host/arch35/sigmoid_grad_tiling_arch35.h"
...
TEST_F(SigmoidGradTiling, sigmoid_grad_test_0) {
    ...
    // compile info
    optiling::SigmoidGradCompileInfo compile_info;
    compile_info.coreNum = 64;
    compile_info.ubSize = 262144;

    string op_type("SigmoidGrad");
