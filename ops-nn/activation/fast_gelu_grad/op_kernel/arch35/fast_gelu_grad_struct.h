...
#ifndef CANN_CUSTOM_OPS_FAST_GELU_GRAD_STRUCT_H_
#define CANN_CUSTOM_OPS_FAST_GELU_GRAD_STRUCT_H_

namespace FastGeluGradOp {
#define TPL_FP16 1
#define TPL_BF16 2
#define TPL_FP32 3
...
ASCENDC_TPL_ARGS_DECL(
    FastGeluGrad, ASCENDC_TPL_UINT_DECL(schMode, 1, ASCENDC_TPL_UI_LIST, TPL_SCH_MODE_0, TPL_SCH_MODE_1),
...
#endif // CANN_CUSTOM_OPS_FAST_GELU_GRAD_STRUCT_H_