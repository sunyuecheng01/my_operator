...
/*!
 * \file silu_grad_dtype_comb_4_nddma_without_loops.h
 * \brief
 */
#ifndef ASCENDC_SILU_GRAD_DTYPE_COMB_4_NDDMA_WITHOUT_LOOPS_H_
#define ASCENDC_SILU_GRAD_DTYPE_COMB_4_NDDMA_WITHOUT_LOOPS_H_
...
class SiluGradDtypeComb4NddmaWithoutLoops {
public:
    __aicore__ inline SiluGradDtypeComb4NddmaWithoutLoops() {};
...
#endif // ASCENDC_SILU_GRAD_DTYPE_COMB_4_NDDMA_WITHOUT_LOOPS_H_
