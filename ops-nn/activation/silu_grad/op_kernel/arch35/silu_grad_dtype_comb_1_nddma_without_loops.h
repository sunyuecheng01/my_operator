...
/*!
 * \file silu_grad_dtype_comb_1_nddma_without_loops.h
 * \brief
 */
#ifndef ASCENDC_SILU_GRAD_DTYPE_COMB_1_NDDMA_WITHOUT_LOOPS_H_
#define ASCENDC_SILU_GRAD_DTYPE_COMB_1_NDDMA_WITHOUT_LOOPS_H_
...
class SiluGradDtypeComb1NddmaWithoutLoops {
public:
    __aicore__ inline SiluGradDtypeComb1NddmaWithoutLoops() {};
...
#endif // ASCENDC_SILU_GRAD_DTYPE_COMB_1_NDDMA_WITHOUT_LOOPS_H_
