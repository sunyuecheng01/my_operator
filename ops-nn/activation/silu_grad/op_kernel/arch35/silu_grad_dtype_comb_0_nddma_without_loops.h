...
/*!
 * \file silu_grad_dtype_comb_0_nddma_without_loops.h
 * \brief
 */
#ifndef ASCENDC_SILU_GRAD_DTYPE_COMB_0_NDDMA_WITHOUT_LOOPS_H_
#define ASCENDC_SILU_GRAD_DTYPE_COMB_0_NDDMA_WITHOUT_LOOPS_H_
...
class SiluGradDtypeComb0NddmaWithoutLoops {
public:
    __aicore__ inline SiluGradDtypeComb0NddmaWithoutLoops() {};
...
#endif // ASCENDC_SILU_GRAD_DTYPE_COMB_0_NDDMA_WITHOUT_LOOPS_H_
