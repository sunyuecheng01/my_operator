...
/*!
 * \file silu_grad_dtype_comb_1_nddma_with_loops.h
 * \brief
 */
#ifndef ASCENDC_SILU_GRAD_DTYPE_COMB_1_NDDMA_WITH_LOOPS_H_
#define ASCENDC_SILU_GRAD_DTYPE_COMB_1_NDDMA_WITH_LOOPS_H_
...
class SiluGradDtypeComb1NddmaWithLoops {
public:
    __aicore__ inline SiluGradDtypeComb1NddmaWithLoops() {};
    ...
    __aicore__ inline void Compute2(int64_t ubSplitSize, const int64_t (&axesIndices)[BROADCAST_MAX_DIMS], int64_t ubLoopIdx)
    {
        ...
        __VEC_SCOPE__ {
            ...
            for (uint16_t i = 0; i < vfLoopNum; i++) {
                ...
                AscendC::MicroAPI::DataCopy<half, AscendC::MicroAPI::LoadDist::DIST_UNPACK_B16>(vreg0, bufferIn0Addr + i * (AscendC::VECTOR_REG_WIDTH / 4));
...
#endif // ASCENDC_SILU_GRAD_DTYPE_COMB_1_NDDMA_WITH_LOOPS_H_
