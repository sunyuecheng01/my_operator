...
/*!
 * \file silu_grad_dtype_comb_5_nddma_without_loops.h
 * \brief
 */
#ifndef ASCENDC_SILU_GRAD_DTYPE_COMB_5_NDDMA_WITHOUT_LOOPS_H_
#define ASCENDC_SILU_GRAD_DTYPE_COMB_5_NDDMA_WITHOUT_LOOPS_H_
...
class SiluGradDtypeComb5NddmaWithoutLoops {
public:
    __aicore__ inline SiluGradDtypeComb5NddmaWithoutLoops() {};
...
#endif // ASCENDC_SILU_GRAD_DTYPE_COMB_5_NDDMA_WITHOUT_LOOPS_H_
