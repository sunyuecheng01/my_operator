...
/*!
 * \file silu_grad_dtype_comb_3_nddma_without_loops.h
 * \brief
 */
#ifndef ASCENDC_SILU_GRAD_DTYPE_COMB_3_NDDMA_WITHOUT_LOOPS_H_
#define ASCENDC_SILU_GRAD_DTYPE_COMB_3_NDDMA_WITHOUT_LOOPS_H_
...
class SiluGradDtypeComb3NddmaWithoutLoops {
public:
    __aicore__ inline SiluGradDtypeComb3NddmaWithoutLoops() {};
...
#endif // ASCENDC_SILU_GRAD_DTYPE_COMB_3_NDDMA_WITHOUT_LOOPS_H_
