...
/*!
 * \file silu_grad_dtype_comb_5_nddma_with_loops.h
 * \brief
 */
#ifndef ASCENDC_SILU_GRAD_DTYPE_COMB_5_NDDMA_WITH_LOOPS_H_
#define ASCENDC_SILU_GRAD_DTYPE_COMB_5_NDDMA_WITH_LOOPS_H_
...
class SiluGradDtypeComb5NddmaWithLoops {
public:
    __aicore__ inline SiluGradDtypeComb5NddmaWithLoops() {};
    ...
    __aicore__ inline void Compute2(int64_t ubSplitSize, const int64_t (&axesIndices)[BROADCAST_MAX_DIMS], int64_t ubLoopIdx)
    {
        ...
        __VEC_SCOPE__ {
            ...
            for (uint16_t i = 0; i < vfLoopNum; i++) {
                ...
                AscendC::MicroAPI::DataCopy<bfloat16_t, AscendC::MicroAPI::LoadDist::DIST_UNPACK_B16>(vreg2, bufferIn1Addr + i * (AscendC::VECTOR_REG_WIDTH / 4));
                ...
                AscendC::MicroAPI::Div<float, AscendC::MicroAPI::MaskMergeMode::ZEROING>(vreg7, vreg1, vreg6, preg0);
                ...
                AscendC::MicroAPI::Add<float, AscendC::MicroAPI::MaskMergeMode::ZEROING>(vreg10, vreg1, vreg9, preg0);
                AscendC::MicroAPI::Mul<float, AscendC::MicroAPI::MaskMergeMode::ZEROING>(vreg11, vreg7, vreg10, preg0);
                AscendC::MicroAPI::Mul<float, AscendC::MicroAPI::MaskMergeMode::ZEROING>(vreg12, vreg0, vreg11, preg0);
...
#endif // ASCENDC_SILU_GRAD_DTYPE_COMB_5_NDDMA_WITH_LOOPS_H_
