...
#include "log/log.h"
#include "../../../op_host/gelu_mul_tiling.h"
...
class GeluMulTiling : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "GeluMulTiling SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "GeluMulTiling TearDown" << std::endl;
  }
};
...
TEST_F(GeluMulTiling, GeluMulTiling_01) {
  size_t M = 2;
  size_t N = 4;
  size_t D = N / 2;
  ...
  platform_info.Init();
  // compile info
  optiling::GeluMulCompileInfo compile_info;

  std::string op_type("GeluMul");
