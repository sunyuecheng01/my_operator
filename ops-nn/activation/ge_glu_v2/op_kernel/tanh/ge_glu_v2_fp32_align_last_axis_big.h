...
/*!
 * \file ge_glu_v2_fp32_align_last_axis_big.h
 * \brief
 */
#ifndef GeGluV2_Float32_LAST_BIG_H
#define GeGluV2_Float32_LAST_BIG_H
...
template <typename T>
class GeGluV2Fp32AlignLastAxisBig : public GeGluV2Base<T>
{
public:
    __aicore__ inline GeGluV2Fp32AlignLastAxisBig(){};
...
template <typename T>
__aicore__ inline void GeGluV2Fp32AlignLastAxisBig<T>::Init(
    GM_ADDR x, GM_ADDR y, GM_ADDR gelu, GM_ADDR workspace, const GeGluV2TilingData* tilingData)
{
...
template <typename T>
__aicore__ inline void GeGluV2Fp32AlignLastAxisBig<T>::Process()
{
...
template <typename T>
__aicore__ inline void GeGluV2Fp32AlignLastAxisBig<T>::ProcessPerCore()
{
    // process core
...
template <typename T>
__aicore__ inline void GeGluV2Fp32AlignLastAxisBig<T>::CopyInX(
...
template <typename T>
__aicore__ inline void GeGluV2Fp32AlignLastAxisBig<T>::ComputeGelu(const int64_t& ub_num)
{
...
template <typename T>
__aicore__ inline void GeGluV2Fp32AlignLastAxisBig<T>::ComputeMul(const int64_t& ub_num)
{
...
template <typename T>
__aicore__ inline void GeGluV2Fp32AlignLastAxisBig<T>::CopyOutGelu(
    const int64_t& idx_x, const int64_t& idx_y, const int64_t& length)
{
...
template <typename T>
__aicore__ inline void GeGluV2Fp32AlignLastAxisBig<T>::CopyOutMul(
    const int64_t& idx_x, const int64_t& idx_y, const int64_t& length)
{
...
#endif // GeGluV2_Float32_LAST_BIG_H