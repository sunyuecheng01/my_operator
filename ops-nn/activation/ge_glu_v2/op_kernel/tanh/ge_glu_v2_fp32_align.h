...
/*!
 * \file ge_glu_v2_fp32_align.h
 * \brief
 */
#ifndef GeGluV2_FLOAT_ALIGN_H
#define GeGluV2_FLOAT_ALIGN_H
...
template <typename T>
__aicore__ inline void GeGluV2Fp32Align<T>::Process()
{
...
template <typename T>
__aicore__ inline void GeGluV2Fp32Align<T>::ProcessPerCore()
{
    // process core
...
template <typename T>
__aicore__ inline void GeGluV2Fp32Align<T>::ProcessLastCore()
{
...
template <typename T>
__aicore__ inline void GeGluV2Fp32Align<T>::CopyInX(const int64_t& index, const int64_t& blockCount)
{
...
template <typename T>
__aicore__ inline void GeGluV2Fp32Align<T>::ComputeGelu(const int64_t& ub_num)
{
...
template <typename T>
__aicore__ inline void GeGluV2Fp32Align<T>::ComputeMul(const int64_t& ub_num)
{
