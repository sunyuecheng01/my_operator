...
/*!
 * \file ge_glu_v2_fp32_vreduce.h
 * \brief
 */
#ifndef GeGluV2_FLOAT_VREDUCE_H
#define GeGluV2_FLOAT_VREDUCE_H
...
template <typename T>
class GeGluV2Fp32VReduce : public GeGluV2Base<T>
{
public:
    __aicore__ inline GeGluV2Fp32VReduce(){};
...
template <typename T>
__aicore__ inline void GeGluV2Fp32VReduce<T>::Init(
    GM_ADDR x, GM_ADDR y, GM_ADDR gelu, GM_ADDR workspace, const GeGluV2TilingData* tilingData)
{
...
template <typename T>
__aicore__ inline void GeGluV2Fp32VReduce<T>::Process()
{
...
template <typename T>
__aicore__ inline void GeGluV2Fp32VReduce<T>::ProcessPerCore()
{
    // process core
...
template <typename T>
__aicore__ inline void GeGluV2Fp32VReduce<T>::ProcessLastCore()
{
...
template <typename T>
__aicore__ inline void GeGluV2Fp32VReduce<T>::CopyInX(const int64_t& index, const int64_t& blockCount)
{
...
template <typename T>
__aicore__ inline void GeGluV2Fp32VReduce<T>::ComputeGeluAndMul(const int64_t& ub_num)
{
...
template <typename T>
__aicore__ inline void GeGluV2Fp32VReduce<T>::CopyOutGelu(
...
template <typename T>
__aicore__ inline void GeGluV2Fp32VReduce<T>::CopyOutMul(
    const int64_t& index, const int64_t& ub_num, const int64_t& group)
{
