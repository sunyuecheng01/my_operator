...
/*!
 * \file ge_glu_v2_bf16_align.h
 * \brief
 */
#ifndef GeGluV2_BFLOAT16_ALIGN_H
#define GeGluV2_BFLOAT16_ALIGN_H
...
template <typename T>
class GeGluV2Bf16Align : public GeGluV2Base<T>
{
public:
    __aicore__ inline GeGluV2Bf16Align(){};
...
template <typename T>
__aicore__ inline void GeGluV2Bf16Align<T>::Init(
    GM_ADDR x, GM_ADDR y, GM_ADDR gelu, GM_ADDR workspace, const GeGluV2TilingData* tilingData)
{
...
template <typename T>
__aicore__ inline void GeGluV2Bf16Align<T>::Process()
{
...
template <typename T>
__aicore__ inline void GeGluV2Bf16Align<T>::ProcessPerCore()
{
    // process core
...
template <typename T>
__aicore__ inline void GeGluV2Bf16Align<T>::ProcessLastCore()
{
...
template <typename T>
__aicore__ inline void GeGluV2Bf16Align<T>::CopyInX(const int64_t& index, const int64_t& blockCount)
{
...
template <typename T>
__aicore__ inline void GeGluV2Bf16Align<T>::ComputeGeluAndMul(const int64_t& ub_num)
{
...
template <typename T>
__aicore__ inline void GeGluV2Bf16Align<T>::CopyOutGelu(
...
template <typename T>
__aicore__ inline void GeGluV2Bf16Align<T>::CopyOutMul(
    const int64_t& index, const int64_t& ub_num, const int64_t& group)
{
...
#endif // GeGluV2_BFLOAT16_ALIGN_H