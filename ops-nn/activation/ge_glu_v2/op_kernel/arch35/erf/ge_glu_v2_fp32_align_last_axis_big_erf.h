...
#ifndef GeGluV2_Float32_LAST_BIG_ERF_H
#define GeGluV2_Float32_LAST_BIG_ERF_H
...
template <typename T>
__aicore__ inline void GeGluV2Fp32AlignLastAxisBigErf<T>::Process()
{
...
template <typename T>
__aicore__ inline void GeGluV2Fp32AlignLastAxisBigErf<T>::ComputeGeluAndMul(const int64_t& ub_num)
{
    ...
    LocalTensor<T> gelu_out;
    this->ComputeGeluErf(gelu_out, outQueueGelu, ubx2_fp32, tmpBuf1, tmpBuf2, ub_num);
...
#endif // GeGluV2_Float32_LAST_BIG_ERF_H