...
#ifndef GeGluV2_BFLOAT16_LAST_BIG_ERF_H
#define GeGluV2_BFLOAT16_LAST_BIG_ERF_H
...
template <typename T>
class GeGluV2Bf16AlignLastAxisBigErf : public GeGluV2Base<T>
{
public:
    __aicore__ inline GeGluV2Bf16AlignLastAxisBigErf(){};
...
template <typename T>
__aicore__ inline void GeGluV2Bf16AlignLastAxisBigErf<T>::Init(
    GM_ADDR x, GM_ADDR y, GM_ADDR gelu, GM_ADDR workspace, const GeGluV2TilingData* tilingData)
{
...
template <typename T>
__aicore__ inline void GeGluV2Bf16AlignLastAxisBigErf<T>::Process()
{
...
template <typename T>
__aicore__ inline void GeGluV2Bf16AlignLastAxisBigErf<T>::ProcessPerCore()
{
    // process core
...
template <typename T>
__aicore__ inline void GeGluV2Bf16AlignLastAxisBigErf<T>::CopyInX(
...
template <typename T>
__aicore__ inline void GeGluV2Bf16AlignLastAxisBigErf<T>::ComputeGeluAndMul(const int64_t& ub_num)
{
    ...
    this->ComputeGeluErf(gelu_result, outQueueGelu, ubx_fp32, tmp_buf1, tmp_buf2, ub_num);
...
template <typename T>
__aicore__ inline void GeGluV2Bf16AlignLastAxisBigErf<T>::CopyOutGelu(
    const int64_t& idx_x, const int64_t& idx_y, const int64_t& length)
{
...
template <typename T>
__aicore__ inline void GeGluV2Bf16AlignLastAxisBigErf<T>::CopyOutMul(
    const int64_t& idx_x, const int64_t& idx_y, const int64_t& length)
{
...
#endif // GeGluV2_BFLOAT16_LAST_BIG_ERF_H