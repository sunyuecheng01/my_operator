...
/*!
 * \file test_softmax_v2_base_tiling.cpp
 * \brief
 */
#include <iostream>
#include <vector>
...
#include "../../../../op_host/arch35/softmax_v2_tiling.h"

using namespace ut_util;
using namespace std;
using namespace ge;

class SoftmaxV2Tiling : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        ...
        std::cout << " SoftmaxV2Tiling SetUp" << std::endl;
    }
    ...
    static void TearDownTestCase()
    {
        ...
        std::cout << " SoftmaxV2Tiling TearDown" << std::endl;
    }
};
