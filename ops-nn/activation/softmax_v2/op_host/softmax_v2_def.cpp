...
public:
  explicit SoftmaxV2(const char *name) : OpDef(name) {
    ...
    this->Output("y")
        .ParamType(REQUIRED)
        .DataType({ge::DT_FLOAT, ge::DT_FLOAT16, ge::DT_BF16, ge::DT_FLOAT})
        .Format({ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND})
        .UnknownShapeFormat({ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND,
                             ge::FORMAT_ND});

    this->Attr("axes").AttrType(OPTIONAL).ListInt({-1});
    this->Attr("half_to_float").AttrType(OPTIONAL).Bool(false);
    ...
    aicoreConfig.DynamicCompileStaticFlag(true)
        ...
        .ExtendCfgInfo("opFile.value", "softmax_v2_apt");
