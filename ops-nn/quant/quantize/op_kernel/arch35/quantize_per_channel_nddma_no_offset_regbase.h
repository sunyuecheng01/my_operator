...
/*!
 * \file quantize_per_channel_nddma_no_offset_regbase.h
 * \brief quantize kernel
 */

#ifndef QUANTIZE_PER_CHANNEL_NDDMA_NO_OFFSET_REGBASE_H_
#define QUANTIZE_PER_CHANNEL_NDDMA_NO_OFFSET_REGBASE_H_
...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerChannelNddmaNoOffsetRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::Init(
    GM_ADDR x, GM_ADDR scale, GM_ADDR offset, GM_ADDR y, const QuantizeTilingData* tilingData)
{
...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerChannelNddmaNoOffsetRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::Process()
{
...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerChannelNddmaNoOffsetRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::CopyInScale(
...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerChannelNddmaNoOffsetRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::CopyInX(
...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerChannelNddmaNoOffsetRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::Compute(
...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerChannelNddmaNoOffsetRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::CopyOutY(
