...
/*!
 * \file quantize_per_channel_regbase.h
 * \brief quantize kernel
 */

#ifndef QUANTIZE_PER_CHANNEL_REGBASE_H_
#define QUANTIZE_PER_CHANNEL_REGBASE_H_
...
class QuantizePerChannelRegbase : public QuantizeBase<T, T1, T2, U, DivMode, RoundMode, SqrtMode> {
public:
    __aicore__ inline QuantizePerChannelRegbase(){};
...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerChannelRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::Init(
    GM_ADDR x, GM_ADDR scale, GM_ADDR offset, GM_ADDR y, const QuantizeTilingData* tilingData)
{
...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerChannelRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::Process()
{
...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerChannelRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::CopyInScale(
...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerChannelRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::CopyInOffset(
    int64_t sLen, int64_t sInOffset)
{
    DataCopyExtParams copyParams;
    copyParams.blockCount = 1;
...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerChannelRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::CopyXAndCompute(
    int64_t dataCount, int64_t offset, LocalTensor<T1>& sLocal, LocalTensor<T2>& oLocal)
{
...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerChannelRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::CopyInX(
...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerChannelRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::Compute(
...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerChannelRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::CopyOutY(
