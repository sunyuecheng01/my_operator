...
#ifndef QUANTIZE_PER_TENSOR_REGBASE_H_
#define QUANTIZE_PER_TENSOR_REGBASE_H_
...
class QuantizePerTensorRegbase : public QuantizeBase<T, T1, T2, U, DivMode, RoundMode, SqrtMode> {
public:
    __aicore__ inline QuantizePerTensorRegbase(){};
...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerTensorRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::Init(
    GM_ADDR x, GM_ADDR scale, GM_ADDR offset, GM_ADDR y, const QuantizeTilingData* tilingData)
{
...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerTensorRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::Process()
{
...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerTensorRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::CopyInScale()
{
...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerTensorRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::CopyInOffset()
{
    DataCopyExtParams copyParams;
    copyParams.blockCount = 1;
...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerTensorRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::CopyXAndCompute(
    int64_t dataCount, int64_t offset, LocalTensor<T1>& sLocal, LocalTensor<T2>& oLocal)
{
...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerTensorRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::CopyInX(
...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerTensorRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::Compute(
        ...
        for (uint16_t j = 0; j < static_cast<uint16_t>(nRow); ++j) {
            ...
            for (uint16_t i = 0; i < vfLoopNum; i++) {
                ...
                if constexpr (IsSameType<T2, int32_t>::value) {
                    // int32
                    AscendC::MicroAPI::DataCopy<T2, AscendC::MicroAPI::LoadDist::DIST_BRC_B32>(vregO, offsetLocalAddr);
                    AscendC::MicroAPI::Cast<
                    ...
                    // int8
                    AscendC::MicroAPI::DataCopy<T2, AscendC::MicroAPI::LoadDist::DIST_BRC_B8>(vregO, offsetLocalAddr);
                    AscendC::MicroAPI::Cast<
                    ...
                    // bf16
                    AscendC::MicroAPI::DataCopy<T2, AscendC::MicroAPI::LoadDist::DIST_BRC_B16>(vregO, offsetLocalAddr);
                    AscendC::MicroAPI::Cast<
                    ...
                    // fp32
                    AscendC::MicroAPI::DataCopy<T2, AscendC::MicroAPI::LoadDist::DIST_BRC_B32>(
                        vregFloatO, offsetLocalAddr);
                }
...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerTensorRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::CopyOutY(
