 ...
 */
/*!
 * \file dynamic_quant_def.cpp
 * \brief
 */
#include "register/op_def_registry.h"

namespace ops {
class DynamicQuant : public OpDef
{
public:
    explicit DynamicQuant(const char* name) : OpDef(name)
    {
        this->Input("x")
            .ParamType(REQUIRED)
        ...
        this->AICore().AddConfig("kirinx90", config_310p_910);
    }
};
