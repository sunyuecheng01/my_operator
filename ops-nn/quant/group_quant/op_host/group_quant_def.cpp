...
namespace ops {
class GroupQuant : public OpDef {
 public:
  explicit GroupQuant(const char* name) : OpDef(name) {
    this->Input("x")
        .ParamType(REQUIRED)
    ...
    this->Output("y")
        .ParamType(REQUIRED)
        .DataType({ge::DT_INT8, ge::DT_INT4, ge::DT_INT8, ge::DT_INT4,
                   ge::DT_INT8, ge::DT_INT4, ge::DT_INT8, ge::DT_INT4,
                   ge::DT_INT8, ge::DT_INT4, ge::DT_INT8, ge::DT_INT4,
                   ge::DT_INT8, ge::DT_INT4, ge::DT_INT8, ge::DT_INT4,
                   ge::DT_INT8, ge::DT_INT4, ge::DT_INT8, ge::DT_INT4,
                   ge::DT_INT8, ge::DT_INT4, ge::DT_INT8, ge::DT_INT4,
