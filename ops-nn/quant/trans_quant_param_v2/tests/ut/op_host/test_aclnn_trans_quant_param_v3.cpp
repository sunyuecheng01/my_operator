...
#include "../../../op_host/op_api/aclnn_trans_quant_param_v3.h"
...
TEST_F(l2_trans_quant_param_v3_test, test_trans_quant_param_first_api)
{
    ...
    auto ut = OP_API_UT(aclnnTransQuantParamV3, INPUT(scale_desc, offset_desc, roundMode), OUTPUT(out_desc));
    uint64_t workspace_size = 0;
    aclnnStatus aclRet = ut.TestGetWorkspaceSize(&workspace_size);
}

TEST_F(l2_trans_quant_param_v3_test, test_trans_quant_param_second_api)
{
    TensorDesc scale_desc = TensorDesc({3}, ACL_FLOAT, ACL_FORMAT_ND);
    TensorDesc offset_desc = TensorDesc({3}, ACL_FLOAT, ACL_FORMAT_ND);
    int64_t roundMode = 2;
...
TEST_F(l2_trans_quant_param_v3_test, test_trans_quant_param_third_api)
{
...
TEST_F(l2_trans_quant_param_v3_test, test_trans_quant_param_fourth_api)
{
...
TEST_F(l2_trans_quant_param_v3_test, test_trans_quant_param_fifth_api)
{
...
TEST_F(l2_trans_quant_param_v3_test, test_trans_quant_param_sixth_api)
{
    TensorDesc scale_desc = TensorDesc({1, 3}, ACL_FLOAT, ACL_FORMAT_ND);
    TensorDesc offset_desc = TensorDesc({1, 3}, ACL_FLOAT, ACL_FORMAT_ND);
    int64_t roundMode = 0;
...
TEST_F(l2_trans_quant_param_v3_test, test_offset_nullptr_invaild_api)
{
    TensorDesc scale_desc = TensorDesc({1, 3}, ACL_FLOAT, ACL_FORMAT_ND);
    int64_t roundMode = 0;
    TensorDesc out_desc = TensorDesc({3}, ACL_UINT64, ACL_FORMAT_ND);
    auto ut = OP_API_UT(aclnnTransQuantParamV3, INPUT(scale_desc, (aclTensor*)nullptr, roundMode), OUTPUT(out_desc));
    uint64_t workspace_size = 0;
    aclnnStatus aclRet = ut.TestGetWorkspaceSize(&workspace_size);
}

TEST_F(l2_trans_quant_param_v3_test, test_format_invalid_api)
{
