 ...
 * 数据类型支持int8,int4,int32,float8_e4m3fn, float8_e5m2, hifloat8, 数据格式支持ND，
 * 支持非连续的Tensor。
 ...
 * @param [in] workspaceSize: 在npu device侧申请的workspace大小，由第一段接口aclnnAscendQuantV3GetWorkspaceSize获取。
...
#endif // OP_API_INC_LEVEL2_ACLNN_ASCEND_QUANT_V3_H_