 ...
 */
ACLNN_API aclnnStatus aclnnAscendAntiQuantGetWorkspaceSize(
...
aclnnAscendAntiQuant(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, aclrtStream stream);
