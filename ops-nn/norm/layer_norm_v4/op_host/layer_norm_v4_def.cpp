...
namespace ops {
class LayerNormV4 : public OpDef {
public:
    explicit LayerNormV4(const char* name) : OpDef(name)
    {
        this->Input("x")
            .ParamType(REQUIRED)
        ...
        membaseCfg.DynamicCompileStaticFlag(true)
            ...
            .ExtendCfgInfo("opFile.value", "layer_norm_v4");
        ...
        config310P.Input("normalized_shape")
            .ParamType(REQUIRED)
        ...
        regbaseCfg.Input("x")
            .ParamType(REQUIRED)
            .DataType(
                {ge::DT_FLOAT, ge::DT_FLOAT16, ge::DT_FLOAT16, ge::DT_BF16, ge::DT_BF16, ge::DT_FLOAT, ge::DT_FLOAT16,
            ...
            .UnknownShapeFormat(
                {ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND,
                 ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND});
        regbaseCfg.Input("normalized_shape")
            .ParamType(REQUIRED)
            .DataType(
            ...
            .UnknownShapeFormat(
                {ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND,
                 ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND});
        regbaseCfg.Input("gamma")
            .ParamType(OPTIONAL)
            .DataType(
                {ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT16, ge::DT_FLOAT, ge::DT_BF16, ge::DT_FLOAT, ge::DT_FLOAT,
...
private:
    OpAICoreConfig GetKirinCoreConfig() const
    {
        ...
        config_kirin.Input("x")
            .ParamType(REQUIRED)
            .DataType({ge::DT_FLOAT, ge::DT_FLOAT16, ge::DT_FLOAT16})
            .Format({ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND})
            .UnknownShapeFormat({ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND});
        config_kirin.Input("normalized_shape")
            .ParamType(REQUIRED)
