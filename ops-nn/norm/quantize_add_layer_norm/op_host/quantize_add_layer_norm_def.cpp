...
/*!
 * \file quantize_add_layer_norm_def.cpp
 * \brief
 */
#include "register/op_def_registry.h"

namespace ops {
class QuantizeAddLayerNorm : public OpDef {
public:
    explicit QuantizeAddLayerNorm(const char* name) : OpDef(name)
    {
        this->Input("x1")
            .ParamType(REQUIRED)
        ...
        this->Output("x")
            ...
            .Format({ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND})
            .UnknownShapeFormat({ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND});
        this->Attr("dtype").AttrType(REQUIRED).Int(ge::DT_INT8);
...
private:
    OpAICoreConfig GetKirinCoreConfig() const
    {
        ...
        config_kirin.Input("scales")
            ...
            .UnknownShapeFormat({ge::FORMAT_ND, ge::FORMAT_ND})
            .AutoContiguous();
        config_kirin.Input("zero_points")
            .ParamType(OPTIONAL)
            .DataType({ge::DT_FLOAT, ge::DT_FLOAT})
            .Format({ge::FORMAT_ND, ge::FORMAT_ND})
            .UnknownShapeFormat({ge::FORMAT_ND, ge::FORMAT_ND})
