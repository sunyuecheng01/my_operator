    ...
    Graph& graph)
{
    ...
    std::vector<int64_t> scalesShape = {8};
    std::vector<int64_t> pointsShape = {8};
    ...
    ADD_INPUT(6, scales, inDtype, scalesShape);
    ADD_INPUT(7, zero_points, inDtype, pointsShape);
    ADD_INPUT_ATTR(dtype, DT_INT8);
