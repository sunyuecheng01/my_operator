...
/*!
 * \file test_ada_layer_norm_quant.cpp
 * \brief
 */
...
TEST_F(ada_layer_norm_quant_test, test_case_bfloat16_1)
{
    ...
    size_t outByteSize = 4 * 16 * 128 * sizeof(int8_t);
    size_t quantScaleByteSize = 4 * 16 * sizeof(float);
    ...
    uint8_t* smoothScales = (uint8_t*)AscendC::GmAlloc(weightByteSize);
    ...
    AscendC::GmFree((void*)smoothScales);
...
TEST_F(ada_layer_norm_quant_test, test_case_bfloat16_2)
{
    ...
    tilingDatafromBin->sliceSize = 5000;
