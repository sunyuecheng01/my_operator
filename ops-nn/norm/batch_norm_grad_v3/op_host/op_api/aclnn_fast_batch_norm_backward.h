 ...
 */
#ifndef OP_API_INC_FAST_BATCH_NORM_BACKWARD_H_
#define OP_API_INC_FAST_BATCH_NORM_BACKWARD_H_
...
/**
 * @brief aclnnFastBatchNormBackwardBackward的第一段接口，根据具体的计算流程，计算workspace大小。
 * @domain aclnn_ops_train
 */
ACLNN_API aclnnStatus aclnnFastBatchNormBackwardGetWorkspaceSize(
...
#endif // OP_API_INC_FAST_BATCH_NORM_BACKWARD_H_
