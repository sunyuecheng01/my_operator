    ...
    GM_ADDR variance_out, GM_ADDR save_mean, GM_ADDR save_var, GM_ADDR workspace, GM_ADDR tiling)
{
    ...
    if (TILING_KEY_IS(BNV3_WELFORD_R0_SPLIT_NOT_ALIGN)) {
        BATCH_NORM_V3_WELFORD_IMPL(
            DTYPE_X, DTYPE_WEIGHT, BNV3WelfordSplitAlignMode::R0_SPLIT_NOT_ALIGN_MODE, BNV3WelfordR0Align::R0_NOT_ALIGN,
            pipe);
    } else if (TILING_KEY_IS(BNV3_WELFORD_R0_SPLIT_ALIGN)) {
        BATCH_NORM_V3_WELFORD_IMPL(
            DTYPE_X, DTYPE_WEIGHT, BNV3WelfordSplitAlignMode::R0_SPLIT_ALIGN_MODE, BNV3WelfordR0Align::R0_NOT_ALIGN,
            pipe);
    } else if (TILING_KEY_IS(BNV3_WELFORD_R1_SPLIT_NOT_ALIGN_RO_NOT_ALIGN)) {
        BATCH_NORM_V3_WELFORD_IMPL(
            DTYPE_X, DTYPE_WEIGHT, BNV3WelfordSplitAlignMode::R1_SPLIT_NOT_ALIGN_MODE, BNV3WelfordR0Align::R0_NOT_ALIGN,
            pipe);
    } else if (TILING_KEY_IS(BNV3_WELFORD_R1_SPLIT_ALIGN_RO_NOT_ALIGN)) {
        BATCH_NORM_V3_WELFORD_IMPL(
            DTYPE_X, DTYPE_WEIGHT, BNV3WelfordSplitAlignMode::R1_SPLIT_ALIGN_MODE, BNV3WelfordR0Align::R0_NOT_ALIGN,
            pipe);
    } else if (TILING_KEY_IS(BNV3_WELFORD_R1_SPLIT_NOT_ALIGN_RO_ALIGN)) {
        BATCH_NORM_V3_WELFORD_IMPL(
            DTYPE_X, DTYPE_WEIGHT, BNV3WelfordSplitAlignMode::R1_SPLIT_NOT_ALIGN_MODE, BNV3WelfordR0Align::R0_ALIGN,
            pipe);
