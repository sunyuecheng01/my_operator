...
/*!
 * \file batch_norm_v3_full_reduce_tiling.cc
 * \brief
 */
...
int64_t BatchNormV3FullReduceTiling::DoUbTiling(const int64_t blockFactor, int64_t& aUbSize, int64_t& rUbSize)
{
    ...
    */
    int64_t eleNum = Ops::Base::FloorDiv(commonParams.ubSizePlatForm, HALF_SIZE);
    ...
    while (aUbFactor > 0) {
        ...
        aUbSize = Ops::Base::CeilAlign(aUbFactor, B16_BLOCK_ALIGN_NUM);
