...
/**
 * @brief aclnnAddRmsNormQuant的第一段接口，根据具体的计算流程，计算workspace大小。
 ...
 */
ACLNN_API aclnnStatus aclnnAddRmsNormQuantGetWorkspaceSize(
 ...
 * @param [in] workspaceSize: 在npu device侧申请的workspace大小，由第一段接口aclnnAddRmsNormQuantGetWorkspaceSize获取。
