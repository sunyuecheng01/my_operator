...
// #include "test_inplace_add_rms_norm_regbase.h"
...
// extern "C" void inplace_add_rms_norm(
//     uint8_t* x1, uint8_t* x2, uint8_t* gamma, uint8_t* y, uint8_t* rstd, uint8_t* x, uint8_t* workspace,
//     uint8_t* tiling);

// class inplace_add_rms_norm_regbase_test : public testing::Test
// {
// protected:
//     static void SetUpTestCase()
//     {
//         cout << "inplace_add_rms_norm_regbase_test SetUp\n" << endl;
//     }
//     static void TearDownTestCase()
//     {
//         cout << "inplace_add_rms_norm_regbase_test TearDown\n" << endl;
//     }
// };

// TEST_F(inplace_add_rms_norm_regbase_test, test_case_key1)
// {
//     int M = 4;
//     int N = 64;
...
// TEST_F(inplace_add_rms_norm_regbase_test, test_case_key2)
// {
//     int M = 4;
//     int N = 64;
...
// TEST_F(inplace_add_rms_norm_regbase_test, test_case_key3)
// {
//     int M = 4;
//     int N = 64;
//     size_t xByteSize = M * N * sizeof(int16_t);
...
// TEST_F(inplace_add_rms_norm_regbase_test, test_case_key1001)
// {
//     int M = 4;
//     int N = 64;
//     size_t xByteSize = M * N * sizeof(int16_t);
...
// TEST_F(inplace_add_rms_norm_regbase_test, test_case_key1002)
// {
//     int M = 4;
//     int N = 64;
//     size_t xByteSize = M * N * sizeof(float);
