...
template <typename T1, typename T2>
__aicore__ inline void GroupNormSwishHW1B32<T1, T2>::Process()
{
...
template <typename T1, typename T2>
__aicore__ inline void GroupNormSwishHW1B32<T1, T2>::ComputeEqualMeanSameType()
{
    int64_t xOffset = 0;
...
template <typename T1, typename T2>
__aicore__ inline void GroupNormSwishHW1B32<T1, T2>::ComputeEqualRstdSameType()
{
