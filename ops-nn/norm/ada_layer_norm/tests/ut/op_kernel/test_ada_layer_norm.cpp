...
TEST_F(ada_layer_norm_test, test_case_bfloat16_1)
{
    ...
    ICPU_RUN_KF(ada_layer_norm, blockDim, x, scale, shift, weight, bias, out, workspace, (uint8_t*)(tilingDatafromBin));
...
TEST_F(ada_layer_norm_test, test_case_bfloat16_2)
{
