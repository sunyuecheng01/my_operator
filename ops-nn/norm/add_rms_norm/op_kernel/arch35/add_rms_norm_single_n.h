...
public:
        ...
        GM_ADDR x1, GM_ADDR x2, GM_ADDR gamma, GM_ADDR y, GM_ADDR rstd, GM_ADDR x, const AddRMSNormTilingData* tiling)
    {
        ...
        x1Gm.SetGlobalBuffer((__gm__ T*)x1 + GetBlockIdx() * numCol, numCol);
        x2Gm.SetGlobalBuffer((__gm__ T*)x2 + GetBlockIdx() * numCol, numCol);
        gammaGm.SetGlobalBuffer((__gm__ T*)gamma, numCol);
        yGm.SetGlobalBuffer((__gm__ T*)y + GetBlockIdx() * numCol, numCol);
        rstdGm.SetGlobalBuffer((__gm__ float*)rstd + GetBlockIdx(), 1);
        xGm.SetGlobalBuffer((__gm__ T*)x + GetBlockIdx() * numCol, numCol);
...
#endif // _ADD_RMS_NORM_SINGLE_N_H_