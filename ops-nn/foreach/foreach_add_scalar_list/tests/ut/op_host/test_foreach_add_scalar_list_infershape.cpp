...
#include "log/log.h"
#include "../../../op_graph/foreach_add_scalar_list_proto.h"

class ForeachAddScalarListTest : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "ForeachAddScalarList SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "ForeachAddScalarList TearDown" << std::endl;
  }
};

TEST_F(ForeachAddScalarListTest, infer_shape_known_success) {
  auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachAddScalarList")->infer_shape;
...
TEST_F(ForeachAddScalarListTest, infer_dtype_test_1) {
  auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachAddScalarList")->infer_datatype;
