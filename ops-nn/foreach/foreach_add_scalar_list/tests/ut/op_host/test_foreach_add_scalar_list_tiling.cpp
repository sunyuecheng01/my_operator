...
#include "../../../../foreach_utils/op_host/foreach_regbase_tiling.h"
...
TEST_F(ForeachCommonTiling, foreach_add_scalar_list_test_tiling_int32_3_regbase) {
    ...
    optiling::ForeachRegbaseTilingUnaryScalarListWithInt tilingInfo(tiling_context);
    // workspaces nullptr return failed
    EXPECT_EQ(tilingInfo.DoTiling(), ge::GRAPH_SUCCESS);
    // todo check tiling result
    auto tiling_key = tiling_context->GetTilingKey();
...
TEST_F(ForeachCommonTiling, foreach_add_scalar_list_test_tiling_int32_4_regbase) {
    ...
    auto workspace_size_holer = gert::ContinuousVector::Create<size_t>(4096);
    auto ws_size = reinterpret_cast<gert::ContinuousVector*>(workspace_size_holer.get());
    gert::StorageShape inputs = {{3, 16, 5}, {3, 16, 5}};
    gert::StorageShape scalar = {{1}, {1}};
    auto holder = gert::TilingContextFaker()
                      .NodeIoNum(2, 1)
                      .IrInstanceNum({1, 1})
...
TEST_F(ForeachCommonTiling, foreach_add_scalar_list_test_tiling_int32_5_regbase) {
    ...
    auto workspace_size_holer = gert::ContinuousVector::Create<size_t>(4096);
    auto ws_size = reinterpret_cast<gert::ContinuousVector*>(workspace_size_holer.get());
    gert::StorageShape inputs = {{3, 6, 15}, {3, 6, 15}};
    gert::StorageShape scalar = {{1}, {1}};
    auto holder = gert::TilingContextFaker()
                      .NodeIoNum(2, 1)
                      .IrInstanceNum({1, 1})
...
TEST_F(ForeachCommonTiling, foreach_add_scalar_list_test_tiling_int32_6_regbase) {
    ...
    auto workspace_size_holer = gert::ContinuousVector::Create<size_t>(4096);
    auto ws_size = reinterpret_cast<gert::ContinuousVector*>(workspace_size_holer.get());
    gert::StorageShape inputs = {{13, 16, 15}, {13, 16, 15}};
    gert::StorageShape scalar = {{1}, {1}};
    auto holder = gert::TilingContextFaker()
                      .NodeIoNum(2, 1)
                      .IrInstanceNum({1, 1})
