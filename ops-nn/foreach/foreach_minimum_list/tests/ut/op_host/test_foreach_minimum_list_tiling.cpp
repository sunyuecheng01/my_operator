...
TEST_F(ForeachCommonTiling, foreach_minimum_list_test_tiling_float16_1)
{
    std::string op_type("ForeachMinimumList");
...
TEST_F(ForeachCommonTiling, foreach_minimum_list_test_tiling_float32_2)
{
    std::string op_type("ForeachMinimumList");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(ForeachCommonTiling, foreach_minimum_list_test_tiling_int32_3)
{
    std::string op_type("ForeachMinimumList");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
