...
#include "log/log.h"
#include "../../../op_graph/foreach_log10_proto.h"

class ForeachLog10Test : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        std::cout << "ForeachLog10 SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "ForeachLog10 TearDown" << std::endl;
    }
};

TEST_F(ForeachLog10Test, infer_shape_known_success)
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachLog10")->infer_shape;
...
TEST_F(ForeachLog10Test, infer_dtype_test_1)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachLog10")->infer_datatype;
