...
/*!
 * \file foreach_zero_inplace_proto.h
 * \brief
 */
#ifndef OPS_OP_PROTO_INC_FOREACH_ZERO_INPLACE_H_
#define OPS_OP_PROTO_INC_FOREACH_ZERO_INPLACE_H_
...
#endif // OPS_OP_PROTO_INC_FOREACH_ZERO_INPLACE_H_
