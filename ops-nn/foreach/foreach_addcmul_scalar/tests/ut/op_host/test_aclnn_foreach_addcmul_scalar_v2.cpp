...
#include "../../../op_host/op_api/aclnn_foreach_addcmul_scalar_v2.h"
...
class l2_foreach_addcmul_scalar_v2_test : public testing::Test {
protected:
  static void SetUpTestCase() { cout << "foreach_addcmul_scalar_test SetUp" << endl; }

  static void TearDownTestCase() { cout << "foreach_addcmul_scalar_test TearDown" << endl; }
};

// private format
TEST_F(l2_foreach_addcmul_scalar_v2_test, ascend910B2_foreach_addcmul_scalar_v2_test_private_format) {
...
TEST_F(l2_foreach_addcmul_scalar_v2_test, ascend910B2_foreach_addcmul_scalar_v2_test_shape_different) {
    vector<vector<int64_t>> selfDims = {{2, 2}};
    auto scalar_desc = ScalarDesc(1.0);
...
TEST_F(l2_foreach_addcmul_scalar_v2_test, ascend910B2_foreach_addcmul_scalar_v2_test_input_shape_different) {
    vector<vector<int64_t>> selfDims = {{2, 2}};
...
TEST_F(l2_foreach_addcmul_scalar_v2_test, ascend910B2_foreach_addcmul_scalar_v2_test_fp16) {
    vector<vector<int64_t>> selfDims = {{2, 2}};
    auto scalar_desc = ScalarDesc(1.0);
    vector<vector<int64_t>> outDims = {{2, 2}};
...
TEST_F(l2_foreach_addcmul_scalar_v2_test, ascend910B2_foreach_addcmul_scalar_v2_test_fp32) {
    vector<vector<int64_t>> selfDims = {{2, 2}};
    auto scalar_desc = ScalarDesc(1.0);
    vector<vector<int64_t>> outDims = {{2, 2}};
    auto x = TensorDesc(selfDims[0], ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
...
TEST_F(l2_foreach_addcmul_scalar_v2_test, ascend910B2_foreach_addcmul_scalar_v2_test_int32) {
    vector<vector<int64_t>> selfDims = {{2, 2}};
    auto scalar_desc = ScalarDesc((int32_t)1);
    vector<vector<int64_t>> outDims = {{2, 2}};
    auto x = TensorDesc(selfDims[0], ACL_INT32, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto x2 = TensorDesc(selfDims[0], ACL_INT32, ACL_FORMAT_ND).ValueRange(-1, 1);
...
// not supported dtype
TEST_F(l2_foreach_addcmul_scalar_v2_test, ascend910B2_foreach_addcmul_scalar_v2_test_not_supported_shape) {
    vector<vector<int64_t>> selfDims = {{2, 2}};
    auto scalar_desc = ScalarDesc(1.0);
    vector<vector<int64_t>> outDims = {{2, 4}};
