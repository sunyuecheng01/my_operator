...
TEST_F(ForeachCommonTiling, foreach_sqrt_test_tiling_float16_1)
{
    std::string op_type("ForeachSqrt");
...
TEST_F(ForeachCommonTiling, foreach_sqrt_test_tiling_float32_2)
{
    std::string op_type("ForeachSqrt");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(ForeachCommonTiling, foreach_sqrt_test_tiling_float16_regbase)
{
    std::string op_type("ForeachSqrt");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(ForeachCommonTiling, foreach_sqrt_test_tiling_float32_regbase)
{
    std::string op_type("ForeachSqrt");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(ForeachCommonTiling, foreach_sqrt_test_tiling_bfloat16_regbase)
{
    std::string op_type("ForeachSqrt");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
