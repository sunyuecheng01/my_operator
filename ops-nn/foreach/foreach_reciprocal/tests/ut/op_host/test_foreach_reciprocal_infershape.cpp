...
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachReciprocal")->infer_shape;
...
TEST_F(ForeachReciprocalTest, infer_dtype_test_1)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachReciprocal")->infer_datatype;
