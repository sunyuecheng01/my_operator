...
/*!
 * \file foreach_sigmoid_proto.h
 * \brief
 */
#ifndef OPS_OP_PROTO_INC_FOREACH_SIGMOID_H_
#define OPS_OP_PROTO_INC_FOREACH_SIGMOID_H_
...
#endif // OPS_OP_PROTO_INC_FOREACH_SIGMOID_H_