...
/*!
 * \file foreach_maximum_scalar_list_def.cpp
 * \brief
 */
...
namespace ops {
class ForeachMaximumScalarList : public OpDef {
public:
    explicit ForeachMaximumScalarList(const char* name) : OpDef(name)
    {
...
OP_ADD(ForeachMaximumScalarList);
} // namespace ops
