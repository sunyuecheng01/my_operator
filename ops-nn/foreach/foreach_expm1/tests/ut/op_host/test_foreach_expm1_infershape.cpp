...
#include "log/log.h"
#include "../../../op_graph/foreach_expm1_proto.h"

class ForeachExpm1Test : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        std::cout << "ForeachExpm1 SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "ForeachExpm1 TearDown" << std::endl;
    }
};

TEST_F(ForeachExpm1Test, infer_shape_known_success)
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachExpm1")->infer_shape;
...
TEST_F(ForeachExpm1Test, infer_dtype_test_1)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachExpm1")->infer_datatype;
