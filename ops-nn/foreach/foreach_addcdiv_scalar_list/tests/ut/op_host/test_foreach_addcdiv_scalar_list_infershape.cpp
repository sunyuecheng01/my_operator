...
#include "log/log.h"
#include "../../../op_graph/foreach_addcdiv_scalar_list_proto.h"

class ForeachAddcdivScalarListTest : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "ForeachAddcdivScalarList SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "ForeachAddcdivScalarList TearDown" << std::endl;
  }
};

TEST_F(ForeachAddcdivScalarListTest, infer_shape_known_success) {
  auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachAddcdivScalarList")->infer_shape;
...
TEST_F(ForeachAddcdivScalarListTest, infer_dtype_test_1) {
  auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachAddcdivScalarList")->infer_datatype;
