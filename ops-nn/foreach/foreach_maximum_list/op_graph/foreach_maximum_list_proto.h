...
/*!
 * \file foreach_maximum_list_proto.h
 * \brief
 */
#ifndef OPS_OP_PROTO_INC_FOREACH_MAXIMUM_LIST_H_
#define OPS_OP_PROTO_INC_FOREACH_MAXIMUM_LIST_H_
...
#endif // OPS_OP_PROTO_INC_FOREACH_MAXIMUM_LIST_H_