...
TEST_F(ForeachCommonTiling, foreach_maximum_list_test_tiling_float16_1)
{
    std::string op_type("ForeachMaximumList");
    ...
    gert::StorageShape inputs1 = {{3, 6, 5}, {3, 6, 5}};
    gert::StorageShape inputs2 = {{3, 6, 5}, {3, 6, 5}};
    gert::StorageShape outputs = {{3, 6, 5}, {3, 6, 5}};
    auto holder = gert::TilingContextFaker()
                      .NodeIoNum(2, 1)
                      .IrInstanceNum({1, 1})
                      .InputShapes({&inputs1, &inputs2})
...
TEST_F(ForeachCommonTiling, foreach_maximum_list_test_tiling_float32_2)
{
    std::string op_type("ForeachMaximumList");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(ForeachCommonTiling, foreach_maximum_list_test_tiling_int32_3)
{
    std::string op_type("ForeachMaximumList");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
