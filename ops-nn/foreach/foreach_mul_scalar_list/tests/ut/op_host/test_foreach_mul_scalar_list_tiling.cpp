...
TEST_F(ForeachCommonTiling, foreach_mul_scalar_list_test_tiling_float16_1)
{
    std::string op_type("ForeachMulScalarList");
    ...
    auto holder = gert::TilingContextFaker()
                      .SetOpType("ForeachMulScalarList")
                      .NodeIoNum(2, 1)
                      .IrInstanceNum({1, 1})
...
TEST_F(ForeachCommonTiling, foreach_mul_scalar_list_test_tiling_float32_2)
{
    std::string op_type("ForeachMulScalarList");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(ForeachCommonTiling, foreach_mul_scalar_list_test_tiling_int32_3)
{
    std::string op_type("ForeachMulScalarList");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(ForeachCommonTiling, foreach_mul_scalar_list_test_tiling_float16_regbase)
{
    std::string op_type("ForeachMulScalarList");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(ForeachCommonTiling, foreach_mul_scalar_list_test_tiling_float32_regbase)
{
    std::string op_type("ForeachMulScalarList");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(ForeachCommonTiling, foreach_mul_scalar_list_test_tiling_int32_regbase)
{
    std::string op_type("ForeachMulScalarList");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
