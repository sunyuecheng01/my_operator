...
#include "log/log.h"
#include "../../../op_graph/foreach_mul_scalar_list_proto.h"

class ForeachMulScalarListTest : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        std::cout << "ForeachMulScalarList SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "ForeachMulScalarList TearDown" << std::endl;
    }
};

TEST_F(ForeachMulScalarListTest, infer_shape_known_success)
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachMulScalarList")->infer_shape;
...
TEST_F(ForeachMulScalarListTest, infer_dtype_test_1)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachMulScalarList")->infer_datatype;
