...
#include "log/log.h"
#include "../../../op_graph/foreach_addcmul_scalar_list_proto.h"

class ForeachAddcmulScalarListTest : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "ForeachAddcmulScalarList SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "ForeachAddcmulScalarList TearDown" << std::endl;
  }
};

TEST_F(ForeachAddcmulScalarListTest, infer_shape_known_success) {
  auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachAddcmulScalarList")->infer_shape;
...
TEST_F(ForeachAddcmulScalarListTest, infer_dtype_test_1) {
  auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachAddcmulScalarList")->infer_datatype;
