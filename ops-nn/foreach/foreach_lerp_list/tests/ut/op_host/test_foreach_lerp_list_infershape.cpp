...
#include "log/log.h"
#include "../../../op_graph/foreach_lerp_list_proto.h"

class ForeachLerpListTest : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        std::cout << "ForeachLerpList SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "ForeachLerpList TearDown" << std::endl;
    }
};

TEST_F(ForeachLerpListTest, infer_shape_known_success)
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachLerpList")->infer_shape;
...
TEST_F(ForeachLerpListTest, infer_dtype_test_1)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachLerpList")->infer_datatype;
    ...
    std::vector<void*> input_dtype_ref(7);
