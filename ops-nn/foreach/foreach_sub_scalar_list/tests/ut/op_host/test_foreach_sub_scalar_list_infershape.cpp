...
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachSubScalarList")->infer_shape;
...
TEST_F(ForeachSubScalarListTest, infer_dtype_test_1)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachSubScalarList")->infer_datatype;
