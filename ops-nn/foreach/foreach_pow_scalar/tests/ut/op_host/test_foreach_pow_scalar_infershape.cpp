...
#include "log/log.h"
#include "../../../op_graph/foreach_pow_scalar_proto.h"

class ForeachPowScalarTest : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        std::cout << "ForeachPowScalar SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "ForeachPowScalar TearDown" << std::endl;
    }
};

TEST_F(ForeachPowScalarTest, infer_shape_known_success)
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachPowScalar")->infer_shape;
...
TEST_F(ForeachPowScalarTest, infer_dtype_test_1)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachPowScalar")->infer_datatype;
