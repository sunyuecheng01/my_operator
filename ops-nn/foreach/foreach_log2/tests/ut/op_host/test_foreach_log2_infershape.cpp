...
#include "log/log.h"
#include "../../../op_graph/foreach_log2_proto.h"

class ForeachLog2Test : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        std::cout << "ForeachLog2 SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "ForeachLog2 TearDown" << std::endl;
    }
};

TEST_F(ForeachLog2Test, infer_shape_known_success)
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachLog2")->infer_shape;
...
TEST_F(ForeachLog2Test, infer_dtype_test_1)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachLog2")->infer_datatype;
