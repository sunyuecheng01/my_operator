...
#include "log/log.h"
#include "../../../op_graph/foreach_addcdiv_scalar_proto.h"

class ForeachAddcdivScalarTest : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "ForeachAddcdivScalar SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "ForeachAddcdivScalar TearDown" << std::endl;
  }
};

TEST_F(ForeachAddcdivScalarTest, infer_shape_known_success) {
  auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachAddcdivScalar")->infer_shape;
...
TEST_F(ForeachAddcdivScalarTest, infer_dtype_test_1) {
  auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachAddcdivScalar")->infer_datatype;
