...
#include "log/log.h"
#include "../../../op_graph/foreach_div_scalar_list_proto.h"

class ForeachDivScalarListTest : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "ForeachDivScalarList SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "ForeachDivScalarList TearDown" << std::endl;
  }
};

TEST_F(ForeachDivScalarListTest, infer_shape_known_success) {
  auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachDivScalarList")->infer_shape;
  ...
  gert::StorageShape x_shape_4 = {{}, {}};
  gert::StorageShape x_shape_5 = {{}, {}};
  //y
...
TEST_F(ForeachDivScalarListTest, infer_dtype_test_1) {
  auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachDivScalarList")->infer_datatype;
