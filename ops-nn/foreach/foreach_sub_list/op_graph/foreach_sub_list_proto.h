...
/*!
 * \file foreach_sub_list_proto.h
 * \brief
 */
#ifndef OPS_OP_PROTO_INC_FOREACH_SUB_LIST_H_
#define OPS_OP_PROTO_INC_FOREACH_SUB_LIST_H_
...
#endif // OPS_OP_PROTO_INC_FOREACH_SUB_LIST_H_
