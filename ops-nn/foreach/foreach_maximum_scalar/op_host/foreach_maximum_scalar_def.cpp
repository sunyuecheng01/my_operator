...
/*!
 * \file foreach_maximum_scalar_def.cpp
 * \brief
 */
...
namespace ops {
class ForeachMaximumScalar : public OpDef {
public:
    explicit ForeachMaximumScalar(const char* name) : OpDef(name)
    {
