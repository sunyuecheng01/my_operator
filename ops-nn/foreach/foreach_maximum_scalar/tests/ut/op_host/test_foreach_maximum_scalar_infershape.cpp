...
#include "log/log.h"
#include "../../../op_graph/foreach_maximum_scalar_proto.h"

class ForeachMaximumScalarTest : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        std::cout << "ForeachMaximumScalar SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "ForeachMaximumScalar TearDown" << std::endl;
    }
};

TEST_F(ForeachMaximumScalarTest, infer_shape_known_success)
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachMaximumScalar")->infer_shape;
...
TEST_F(ForeachMaximumScalarTest, infer_dtype_test_1)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachMaximumScalar")->infer_datatype;
