...
/*!
 * \file foreach_maximum_scalar_proto.h
 * \brief
 */
#ifndef OPS_OP_PROTO_INC_FOREACH_MAXIMUM_SCALAR_H_
#define OPS_OP_PROTO_INC_FOREACH_MAXIMUM_SCALAR_H_
...
#endif // OPS_OP_PROTO_INC_FOREACH_MAXIMUM_SCALAR_H_