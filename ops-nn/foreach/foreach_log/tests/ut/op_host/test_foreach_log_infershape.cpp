...
#include "log/log.h"
#include "../../../op_graph/foreach_log_proto.h"

class ForeachLogTest : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        std::cout << "ForeachLog SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "ForeachLog TearDown" << std::endl;
    }
};

TEST_F(ForeachLogTest, infer_shape_known_success)
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachLog")->infer_shape;
...
TEST_F(ForeachLogTest, infer_dtype_test_1)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachLog")->infer_datatype;
