...
/*!
 * \file test_foreach_addcdiv_list.cpp
 * \brief
 */
...
TEST_F(foreach_addcdiv_list_test, test_case_float_1) {
    ...
    uint8_t* x1 = CreateTensorListForeachAddcdivList<float>(shapeInfos, "float32", "input");
    uint8_t* tensor1 = CreateTensorListForeachAddcdivList<float>(shapeInfos, "float32", "tensor1");
...
TEST_F(foreach_addcdiv_list_test, test_case_float16_2) {
    ...
    uint8_t* x1 = CreateTensorListForeachAddcdivList<half>(shapeInfos, "float16", "input");
    uint8_t* tensor1 = CreateTensorListForeachAddcdivList<half>(shapeInfos, "float16", "tensor1");
...
TEST_F(foreach_addcdiv_list_test, test_case_bfloat16_3) {
    ...
    uint8_t* x1 = CreateTensorListForeachAddcdivList<bfloat16_t>(shapeInfos, "bfloat16_t", "input");
    uint8_t* tensor1 = CreateTensorListForeachAddcdivList<bfloat16_t>(shapeInfos, "bfloat16_t", "tensor1");
