...
#include "log/log.h"
#include "../../../op_graph/foreach_addcdiv_list_proto.h"

class ForeachAddcdivListTest : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "ForeachAddcdivList SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "ForeachAddcdivList TearDown" << std::endl;
  }
};

TEST_F(ForeachAddcdivListTest, infer_shape_known_success) {
  auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachAddcdivList")->infer_shape;
...
TEST_F(ForeachAddcdivListTest, infer_dtype_test_1) {
  auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachAddcdivList")->infer_datatype;
