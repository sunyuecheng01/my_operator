...
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachPowScalarList")->infer_shape;
...
TEST_F(ForeachPowScalarListTest, infer_dtype_test_1)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachPowScalarList")->infer_datatype;
