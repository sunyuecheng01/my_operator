...
/*!
 * \file foreach_pow_scalar_list_def.cpp
 * \brief
 */
...
namespace ops {
class ForeachPowScalarList : public OpDef {
public:
    explicit ForeachPowScalarList(const char* name) : OpDef(name)
    {
