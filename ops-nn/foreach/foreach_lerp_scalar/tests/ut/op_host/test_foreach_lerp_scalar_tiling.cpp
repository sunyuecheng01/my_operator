...
TEST_F(ForeachCommonTiling, foreach_lerp_scalar_test_tiling_float16_1)
{
    std::string op_type("ForeachLerpScalar");
...
TEST_F(ForeachCommonTiling, foreach_lerp_scalar_test_tiling_float32_2)
{
    std::string op_type("ForeachLerpScalar");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(ForeachCommonTiling, foreach_lerp_scalar_test_tiling_int32_3)
{
    std::string op_type("ForeachLerpScalar");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(ForeachCommonTiling, foreach_lerp_scalar_test_tiling_float32_regbase)
{
    std::string op_type("ForeachLerpScalar");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    gert::StorageShape scalar = {{1}, {1}};
    auto holder = gert::TilingContextFaker()
                      .SetOpType("ForeachLerpScalar")
                      .NodeIoNum(3, 1)
                      .IrInstanceNum({1, 1, 1})
                      .InputShapes({&inputs, &inputs1, &scalar})
                      .OutputShapes({&inputs})
                      .CompileInfo(&compile_info)
                      .PlatformInfo(reinterpret_cast<char*>(&platform_info))
                      .NodeInputTd(0, ge::DT_FLOAT, ge::FORMAT_ND, ge::FORMAT_ND)
