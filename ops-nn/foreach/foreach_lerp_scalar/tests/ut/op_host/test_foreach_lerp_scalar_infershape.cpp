...
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachLerpScalar")->infer_shape;
...
TEST_F(ForeachLerpScalarTest, infer_dtype_test_1)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachLerpScalar")->infer_datatype;
