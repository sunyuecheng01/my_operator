...
#include "log/log.h"
#include "../../../op_graph/foreach_pow_list_proto.h"

class ForeachPowListTest : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        std::cout << "ForeachPowList SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "ForeachPowList TearDown" << std::endl;
    }
};

TEST_F(ForeachPowListTest, infer_shape_known_success)
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachPowList")->infer_shape;
...
TEST_F(ForeachPowListTest, infer_dtype_test_1)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachPowList")->infer_datatype;
