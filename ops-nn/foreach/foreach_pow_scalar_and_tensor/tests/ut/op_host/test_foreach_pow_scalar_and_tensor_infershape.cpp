...
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachPowScalarAndTensor")->infer_shape;
    ASSERT_NE(infer_shape_func, nullptr);
    // alpha
    gert::StorageShape x_shape_0 = {{}, {}};
    // x1
    gert::StorageShape x_shape_1 = {{1, 2, 3}, {}};
    gert::StorageShape x_shape_2 = {{2, 3, 4}, {}};
    gert::StorageShape x_shape_3 = {{3, 4, 5}, {}};
    ...
    EXPECT_EQ(Ops::Base::ToString(*output_shape_0), "[1, 2, 3]");

    auto output_shape_1 = context->GetOutputShape(1);
    EXPECT_EQ(Ops::Base::ToString(*output_shape_1), "[2, 3, 4]");

    auto output_shape_2 = context->GetOutputShape(2);
    EXPECT_EQ(Ops::Base::ToString(*output_shape_2), "[3, 4, 5]");
}
