...
#include "log/log.h"
#include "../../../op_graph/foreach_tanh_proto.h"

class ForeachTanhTest : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        std::cout << "ForeachTanh SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "ForeachTanh TearDown" << std::endl;
    }
};

TEST_F(ForeachTanhTest, infer_shape_known_success)
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachTanh")->infer_shape;
...
TEST_F(ForeachTanhTest, infer_dtype_test_1)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachTanh")->infer_datatype;
