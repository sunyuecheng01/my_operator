...
/*!
 * \file aclnn_foreach_sub_scalar_v2.h
 * \brief
 */
 ...
 * device侧申请的workspace大小，由第一段接口aclnnForeachSubScalarV2GetWorkspaceSize获取。 param [in] stream: acl
 * stream流。 param [in] executor: op执行器，包含了算子计算流程。 return aclnnStatus: 返回状态码。
 */
ACLNN_API aclnnStatus
aclnnForeachSubScalarV2(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, const aclrtStream stream);
