...
#include "log/log.h"
#include "../../../op_graph/foreach_sub_scalar_proto.h"

class ForeachSubScalarTest : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        std::cout << "ForeachSubScalar SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "ForeachSubScalar TearDown" << std::endl;
    }
};

TEST_F(ForeachSubScalarTest, infer_shape_known_success)
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachSubScalar")->infer_shape;
...
TEST_F(ForeachSubScalarTest, infer_dtype_test_1)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachSubScalar")->infer_datatype;
