...
#include "log/log.h"
#include "../../../op_graph/foreach_addcmul_list_proto.h"

class ForeachAddcmulListTest : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "ForeachAddcmulList SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "ForeachAddcmulList TearDown" << std::endl;
  }
};

TEST_F(ForeachAddcmulListTest, infer_shape_known_success) {
  auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachAddcmulList")->infer_shape;
...
TEST_F(ForeachAddcmulListTest, infer_dtype_test_1) {
  auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachAddcmulList")->infer_datatype;
