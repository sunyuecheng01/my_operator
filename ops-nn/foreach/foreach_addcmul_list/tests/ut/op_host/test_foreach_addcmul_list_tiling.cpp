...
TEST_F(ForeachSoloTiling, foreach_addcmul_list_test_tiling_float16_1) {
    std::string op_type("ForeachAddcmulList");
...
TEST_F(ForeachSoloTiling, foreach_addcmul_list_test_tiling_float32_2) {
    std::string op_type("ForeachAddcmulList");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    auto tiling_parse_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling_parse;
...
TEST_F(ForeachSoloTiling, foreach_addcmul_list_test_tiling_int32_3) {
    std::string op_type("ForeachAddcmulList");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    auto tiling_parse_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling_parse;
