...
#include "log/log.h"
#include "../../../op_graph/foreach_sinh_proto.h"

class ForeachSinhTest : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        std::cout << "ForeachSinh SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "ForeachSinh TearDown" << std::endl;
    }
};

TEST_F(ForeachSinhTest, infer_shape_known_success)
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachSinh")->infer_shape;
...
TEST_F(ForeachSinhTest, infer_dtype_test_1)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachSinh")->infer_datatype;
