...
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachMinimumScalar")->infer_shape;
...
TEST_F(ForeachMinimumScalarTest, infer_dtype_test_1)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachMinimumScalar")->infer_datatype;
