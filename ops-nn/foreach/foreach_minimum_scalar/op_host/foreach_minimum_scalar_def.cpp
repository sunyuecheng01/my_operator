...
/*!
 * \file foreach_minimum_scalar_def.cpp
 * \brief
 */
...
namespace ops {
class ForeachMinimumScalar : public OpDef {
public:
    explicit ForeachMinimumScalar(const char* name) : OpDef(name)
    {
