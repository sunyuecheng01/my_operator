...
TEST_F(ForeachCommonTiling, foreach_mul_scalar_test_tiling_float16_1)
{
    std::string op_type("ForeachMulScalar");
...
TEST_F(ForeachCommonTiling, foreach_mul_scalar_test_tiling_float32_2)
{
    std::string op_type("ForeachMulScalar");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(ForeachCommonTiling, foreach_mul_scalar_test_tiling_int32_3)
{
    std::string op_type("ForeachMulScalar");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(ForeachCommonTiling, foreach_mul_scalar_test_tiling_float32_regbase)
{
    std::string op_type("ForeachMulScalar");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
