...
#include "log/log.h"
#include "../../../op_graph/foreach_tan_proto.h"

class ForeachTanTest : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        std::cout << "ForeachTan SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "ForeachTan TearDown" << std::endl;
    }
};

TEST_F(ForeachTanTest, infer_shape_known_success)
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachTan")->infer_shape;
...
TEST_F(ForeachTanTest, infer_dtype_test_1)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachTan")->infer_datatype;
