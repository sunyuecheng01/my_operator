 ...
 */
#ifndef OP_API_INC_LEVEL0_OP_FUSED_CROSS_ENTROPY_LOSS_WITH_MAX_SUM_H_
#define OP_API_INC_LEVEL0_OP_FUSED_CROSS_ENTROPY_LOSS_WITH_MAX_SUM_H_
...
#endif // OP_API_INC_LEVEL0_OP_FUSED_CROSS_ENTROPY_LOSS_WITH_MAX_SUM_H_
