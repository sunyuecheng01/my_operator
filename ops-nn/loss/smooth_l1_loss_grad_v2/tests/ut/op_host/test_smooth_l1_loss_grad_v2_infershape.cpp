...
/*!
 * \file test_smooth_l1_loss_grad_v2_infershape.cpp
 * \brief
 */
...
TEST_F(smooth_l1_loss_grad_v2, smooth_l1_loss_grad_v2_test1)
{
    ...
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("SmoothL1LossGradV2")->infer_shape;
    gert::Shape predictShape = {3, 4, 5};
    gert::Shape labelShape = {3, 4, 5};
    gert::Shape doutShape = {3, 4, 5};
