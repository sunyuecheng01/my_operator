...
class CrossEntropyLossGradTiling : public testing::Test {
protected:
    static void SetUpTestCase() {
        std::cout << "CrossEntropyLossGradTiling SetUp" << std::endl;
    }

    static void TearDownTestCase() {
        std::cout << "CrossEntropyLossGradTiling TearDown" << std::endl;
    }
};
...
TEST_F(CrossEntropyLossGradTiling, test_tiling_weight_not_none_bf16_11) {
  ...
  gert::StorageShape weight_shape = {{1024, }, {1024, }};

  // output
  gert::StorageShape x_grad_shape = {{30, 1024}, {30, 1024}};
  ...
  CrossEntropyLossGradCompileInfo compile_info;

  std::string op_type("CrossEntropyLossGrad");
  ...
  auto holder = gert::TilingContextFaker()
                    ...
                    .InputShapes({&grad_loss_shape, &log_prob_shape, &target_shape, &weight_shape})
...
TEST_F(CrossEntropyLossGradTiling, test_tiling_weight_none_bf16_10) {
  ...
  auto holder = gert::TilingContextFaker()
                    ...
                    .NodeIoNum(3, 1)
                    .IrInstanceNum({1, 1, 1})
                    .InputShapes({&grad_loss_shape, &log_prob_shape, &target_shape})
                    .OutputShapes({&x_grad_shape})
                    .CompileInfo(&compile_info)
                    .PlatformInfo(reinterpret_cast<char *>(&platform_info))
                    .NodeInputTd(0, ge::DT_BF16, ge::FORMAT_ND, ge::FORMAT_ND)
