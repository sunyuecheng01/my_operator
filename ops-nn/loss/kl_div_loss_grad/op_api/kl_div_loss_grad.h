 ...
 * \brief
 */
#ifndef PTA_NPU_OP_API_INC_LEVEL0_OP_KL_DIV_LOSS_GRAD_OP_H_
#define PTA_NPU_OP_API_INC_LEVEL0_OP_KL_DIV_LOSS_GRAD_OP_H_
...
#endif  // PTA_NPU_OP_API_INC_LEVEL0_OP_KL_DIV_LOSS_GRAD_OP_H_
