...
/*!
 * \file adam_apply_one_infershape.cpp
 * \brief
 */
...
static ge::graphStatus InferShape4AdamApplyOne(gert::InferShapeContext* context)
{
...
IMPL_OP_INFERSHAPE(AdamApplyOne).InferShape(InferShape4AdamApplyOne);
} // namespace ops
