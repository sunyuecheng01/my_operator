 /**
	 ...
	 #define ADD_INPUT(intputIndex, intputName, intputDtype, inputShape)                                             \
	     ...
	     adamApplyOne1.set_input_##intputName(placeholder##intputIndex);                                             \
	     inputs.push_back(placeholder##intputIndex);

	 #define ADD_INPUT_ATTR(attrName, attrValue) adamApplyOne1.set_attr_##attrName(attrValue);
	 ...
	 #define ADD_CONST_INPUT(intputIndex, intputName, intputDtype, inputShape)                                   \
	     ...
	     graph.AddOp(placeholder##intputIndex);                                                                  \
	     adamApplyOne1.set_input_##intputName(placeholder##intputIndex);                                         \
	     adamApplyOne1.update_input_desc_##intputName(placeholder##intputIndex##_desc);                          \
	     inputs.push_back(placeholder##intputIndex);

	 #define ADD_OUTPUT(outputIndex, outputName, outputDtype, outputShape)                                        \
	     TensorDesc outputName##outputIndex##_desc_ = TensorDesc(ge::Shape(outputShape), FORMAT_ND, outputDtype); \
	     adamApplyOne1.update_output_desc_##outputName(outputName##outputIndex##_desc);
	     ...
	     Graph& graph)
	 {
	     Status ret = SUCCESS;
	     // 自定义代码：添加单算子定义到图中
	     auto adamApplyOne1 = op::AdamApplyOne("adamApplyOne1");
	     ...
	     ADD_INPUT(10, add2_y, inDtype, xShape);

	     outputs.push_back(adamApplyOne1);
	     // 添加完毕
	     return SUCCESS;
	 }
