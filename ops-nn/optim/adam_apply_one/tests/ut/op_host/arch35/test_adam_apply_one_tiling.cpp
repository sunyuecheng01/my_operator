...
#include "optim/adam_apply_one/op_host/arch35/adam_apply_one_tiling_arch35.h"
...
TEST_F(AdamApplyOneTilingTest, AdamApplyOne_tiling_test_1)
{
    ...
    // compile info
    optiling::AdamApplyOneCompileInfo compile_info;

    string op_type("AdamApplyOne");
...
TEST_F(AdamApplyOneTilingTest, AdamApplyOne_tiling_test_2)
{
    gert::StorageShape input0_shape = {{16, 8, 375}, {16, 8, 375}};
    gert::StorageShape input1_shape = {{16, 8, 375}, {16, 8, 375}};
    gert::StorageShape input2_shape = {{16, 8, 375}, {16, 8, 375}};
...
TEST_F(AdamApplyOneTilingTest, AdamApplyOne_tiling_test_3)
{
    gert::StorageShape input0_shape = {{16, 8, 32, 16}, {16, 8, 32, 16}};
    gert::StorageShape input1_shape = {{16, 8, 32, 16}, {16, 8, 32, 16}};
    gert::StorageShape input2_shape = {{16, 8, 32, 16}, {16, 8, 32, 16}};
    gert::StorageShape input3_shape = {{16, 8, 32, 16}, {16, 8, 32, 16}};
    gert::StorageShape input4_shape = {{1}, {1}};
    gert::StorageShape input5_shape = {{1}, {1}};
    gert::StorageShape input6_shape = {{1}, {1}};
    gert::StorageShape input7_shape = {{1}, {1}};
...
TEST_F(AdamApplyOneTilingTest, AdamApplyOne_tiling_test_4)
{
...
TEST_F(AdamApplyOneTilingTest, AdamApplyOne_tiling_test_5)
{
    gert::StorageShape input0_shape = {{16, 16, 16}, {16, 16, 16}};
    gert::StorageShape input1_shape = {{16, 16, 16}, {16, 16, 16}};
    gert::StorageShape input2_shape = {{16, 16, 16}, {16, 16, 16}};
...
TEST_F(AdamApplyOneTilingTest, AdamApplyOne_tiling_test_6)
{
    gert::StorageShape input0_shape = {{16, 16, 16}, {16, 16, 16}};
    gert::StorageShape input1_shape = {{16, 16, 16}, {16, 16, 16}};
    gert::StorageShape input2_shape = {{16, 16, 16}, {16, 16, 16}};
