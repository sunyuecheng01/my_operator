...
/*!
 * \file apply_gradient_descent_tiling_key.h
 * \brief apply_gradient_descent tiling key
 */
#ifndef APPLY_GRADIENT_DESCENT_TILING_KEY_H
#define APPLY_GRADIENT_DESCENT_TILING_KEY_H
...
ASCENDC_TPL_ARGS_DECL(ApplyGradientDescent,
...
ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(schMode, ASCENDC_TPL_UI_LIST, ELEMENTWISE_TPL_SCH_MODE_0,
                                                          ELEMENTWISE_TPL_SCH_MODE_1)));
#endif  // APPLY_GRADIENT_DESCENT_TILING_KEY_H