...
/*!
 * \file adam_apply_one_with_decay_infershape.cpp
 * \brief
 */
...
static ge::graphStatus InferShape4AdamApplyOneWithDecay(gert::InferShapeContext* context)
{
...
IMPL_OP_INFERSHAPE(AdamApplyOneWithDecay).InferShape(InferShape4AdamApplyOneWithDecay);
} // namespace ops
