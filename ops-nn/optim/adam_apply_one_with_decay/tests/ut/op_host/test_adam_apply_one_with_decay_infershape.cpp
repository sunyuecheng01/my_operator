...
class AdamApplyOneWithDecayProtoTest : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "AdamApplyOneWithDecayProtoTest SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "AdamApplyOneWithDecayProtoTest TearDown" << std::endl;
    }
};

TEST_F(AdamApplyOneWithDecayProtoTest, adam_apply_one_with_decay_case_0)
{
    ...
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("AdamApplyOneWithDecay")->infer_shape;
...
TEST_F(AdamApplyOneWithDecayProtoTest, infer_axis_type_with_input_dim_num_equals_1)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
...
TEST_F(AdamApplyOneWithDecayProtoTest, infer_axis_type_with_input_dim_num_great_than_1)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
