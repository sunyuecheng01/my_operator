...
const uint32_t DTYPE_BF16_KEY = 100;
const uint32_t DTYPE_FP16_KEY = 101;
const uint32_t DTYPE_FP32_KEY = 102;
...
#endif // OPS_BUILD_IN_OP_TILING_RUNTIME_APPLY_FUSED_EMA_ADAM_TILING_H_