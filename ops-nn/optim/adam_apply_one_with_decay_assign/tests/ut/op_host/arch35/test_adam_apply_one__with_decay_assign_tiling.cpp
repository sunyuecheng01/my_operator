...
#include "optim/adam_apply_one_with_decay_assign/op_host/arch35/adam_apply_one_with_decay_assign_tiling_arch35.h"
...
TEST_F(AdamApplyOneWithDecayAssignTilingTest, AdamApplyOneWithDecayAssign_tiling_test_1)
{
    ...
    // compile info
    optiling::AdamApplyOneWithDecayAssignCompileInfo compile_info;
    compile_info.coreNum = 64;
    compile_info.ubSize = 245760;

    string op_type("AdamApplyOneWithDecayAssign");
...
TEST_F(AdamApplyOneWithDecayAssignTilingTest, AdamApplyOneWithDecayAssign_tiling_test_2)
{
    gert::StorageShape input0_shape = {{16, 8, 375}, {16, 8, 375}};
    gert::StorageShape input1_shape = {{16, 8, 375}, {16, 8, 375}};
    gert::StorageShape input2_shape = {{16, 8, 375}, {16, 8, 375}};
...
TEST_F(AdamApplyOneWithDecayAssignTilingTest, AdamApplyOneWithDecayAssign_tiling_test_3)
{
