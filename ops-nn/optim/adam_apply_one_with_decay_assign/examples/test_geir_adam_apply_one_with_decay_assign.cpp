/**
	 ...
	 #define ADD_CONST_INPUT(intputIndex, intputName, intputDtype, inputShape)                                   \
	     ...
	     graph.AddOp(placeholder##intputIndex);                                                                  \
	     adamApplyOneWithDecayAssign1.set_input_##intputName(placeholder##intputIndex);                          \
	     adamApplyOneWithDecayAssign1.update_input_desc_##intputName(placeholder##intputIndex##_desc);           \
	     inputs.push_back(placeholder##intputIndex);
	     ...
	     Graph& graph)
	 {
	     Status ret = SUCCESS;
	     // 自定义代码：添加单算子定义到图中
	     auto adamApplyOneWithDecayAssign1 = op::AdamApplyOneWithDecayAssign("adamApplyOneWithDecayAssign1");
	     std::vector<int64_t> xShape = {(640)};
	     ...
	     ADD_INPUT(5, input4, inDtype, {});
	     ADD_INPUT(6, mul0_x, inDtype, {});
	     ADD_INPUT(7, mul1_x, inDtype, {});
	     ADD_INPUT(8, mul2_x, inDtype, {});
	     ADD_INPUT(9, mul3_x, inDtype, {});
	     ADD_INPUT(10, mul4_x, inDtype, {});
	     ADD_INPUT(11, add2_y, inDtype, {});

	     outputs.push_back(adamApplyOneWithDecayAssign1);
	     // 添加完毕
	     return SUCCESS;
	 }
