...
/*!
 * \file    adam_apply_one_with_decay_assign_dag.h
 * \brief adam_apply_one_with_decay_assign_dag head file
 */

#ifndef ADAM_APPLY_ONE_WITH_DECAY_ASSIGN_DAG_H
#define ADAM_APPLY_ONE_WITH_DECAY_ASSIGN_DAG_H
#include "atvoss/util/dag.h"
#include "atvoss/util/vec.h"
#include "atvoss/util/placeholder.h"
namespace AdamApplyOneWithDecayAssignOp {
using namespace AscendC;
using namespace Ops::Base;
template <typename T, typename U>
struct AdamApplyOneWithDecayAssignCompute {
    ...
    using OpInput4 = Bind<Vec::Duplicate<T>, Placeholder::In4<T, Placeholder::ScalarAttr<true>>>;
    using OpMul0X = Bind<Vec::Duplicate<T>, Placeholder::In5<T, Placeholder::ScalarAttr<true>>>;
    using OpMul1X = Bind<Vec::Duplicate<T>, Placeholder::In6<T, Placeholder::ScalarAttr<true>>>;
    using OpMul2X = Bind<Vec::Duplicate<T>, Placeholder::In7<T, Placeholder::ScalarAttr<true>>>;
    using OpMul3X = Bind<Vec::Duplicate<T>, Placeholder::In8<T, Placeholder::ScalarAttr<true>>>;
    using OpMul4X = Bind<Vec::Duplicate<T>, Placeholder::In9<T, Placeholder::ScalarAttr<true>>>;
    using OpAdd2Y = Bind<Vec::Duplicate<T>, Placeholder::In10<T, Placeholder::ScalarAttr<true>>>;
    ...
    using OpMul4XCast = Bind<Vec::Cast<U, T, 0>, OpMul4X>;
    ...
    using OpTmp5 = Bind<Vec::Mul<U>, OpInput3Cast, OpMul4XCast>;
    ...
    using OpTmp2Add = Bind<Vec::Add<U>, OpTmpDiv, OpTmp5>;
    using OpTmpMul = Bind<Vec::Mul<U>, OpTmp2Add, OpInput4Cast>;
...
#endif // ADAM_APPLY_ONE_WITH_DECAY_ASSIGN_DAG_H
