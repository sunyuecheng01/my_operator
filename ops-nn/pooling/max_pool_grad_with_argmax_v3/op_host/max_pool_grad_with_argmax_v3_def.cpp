 ...
 * \brief imply for max_pool_grad_with_argmax
 */
...
namespace ops {
constexpr int32_t DTYPE_INT32 = 3;
class MaxPoolGradWithArgmaxV3 : public OpDef {
public:
    explicit MaxPoolGradWithArgmaxV3(const char* name) : OpDef(name)
    {
        this->Input("x")
            .ParamType(REQUIRED)
        ...
        aiCoreConfig.DynamicCompileStaticFlag(true)
            ...
            .ExtendCfgInfo("opFile.value", "max_pool_grad_with_argmax_v3");
        this->AICore().AddConfig("ascend910_95", aiCoreConfig);
    }
};

OP_ADD(MaxPoolGradWithArgmaxV3);
} // namespace ops