 ...
 */
ACLNN_API aclnnStatus aclnnAvgPool2dBackwardGetWorkspaceSize(
...
aclnnAvgPool2dBackward(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, aclrtStream stream);
