...
int main() {
  ...
  std::vector<int64_t> gradOutShape = {1, 1, 2, 1, 1};
  std::vector<int64_t> selfShape = {1, 1, 3, 2, 2};
  std::vector<int64_t> indicesShape = {1, 1, 2, 1, 1};
  std::vector<int64_t> gradInShape = {1, 1, 3, 2, 2};
  ...
  std::vector<float> gradOutHostData = {0.4757, 0.3232};
  std::vector<float> selfHostData = {0.0850, -0.5147, -0.0212, -0.5654, -0.3222, 0.5847, 1.7510, 0.9954, 0.1234, -0.6789, 2.3456, -1.2345};
  std::vector<int32_t> indicesHostData = {6, 10};
