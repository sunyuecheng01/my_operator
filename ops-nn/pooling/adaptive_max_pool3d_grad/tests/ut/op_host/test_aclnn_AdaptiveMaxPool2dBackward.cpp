...
#include "../../../op_host/op_api/aclnn_adaptive_max_pool2d_backward.h"
...
protected:
    ...
    {
        std::cout << "l2_adaptive_max_pool2d_backward_test SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "l2_adaptive_max_pool2d_backward_test TearDown" << std::endl;
    }
};
...
TEST_F(l2_adaptive_max_pool2d_backward_test, ascend910B2_normal_float)
{
    ...
    auto ut = OP_API_UT(
        aclnnAdaptiveMaxPool2dBackward, INPUT(tensor_gradOutput, tensor_self, indices_tensor_desc),
