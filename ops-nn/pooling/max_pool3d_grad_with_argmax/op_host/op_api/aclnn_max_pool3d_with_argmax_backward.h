...
/**
 * @brief aclnnMaxPool3dWithArgmaxBackward First segment interface. Calculate the workspace size based on the specific
 * calculation process. Function description: Calculates MaxPool3DGradWithArgmax from the gradOutput and self, at the
 * result gradInput
...
ACLNN_API aclnnStatus aclnnMaxPool3dWithArgmaxBackwardGetWorkspaceSize(
 ...
 * segment interface aclnnMaxPool3dWithArgmaxBackwardGetWorkspaceSize.
