...
int main() {
  ...
  std::vector<int64_t> gradOutShape = {1, 1, 2, 2};
  std::vector<int64_t> selfShape = {1, 1, 4, 3};
  std::vector<int64_t> indicesShape = {1, 1, 1, 64};
  std::vector<int64_t> gradInShape = {1, 1, 4, 3};
  std::vector<int64_t> kernelSizeData = {1, 1};  // 全为1的场景，走的是2d算子，否则走3d
  ...
  std::vector<int8_t> indicesHostData(64, 0);
