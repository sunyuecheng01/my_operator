...
static void ExecuteTestCase(gert::StorageShape xShape, gert::StorageShape yShape, std::vector<int64_t> ksize,
                            std::vector<int64_t> strides, std::string padding, std::vector<int64_t> pads,
                            std::vector<int64_t> dilation, std::string data_format, int64_t ceil_mode,
                            ge::DataType dtype, uint64_t except_tilingkey, std::string expect)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeAttrs({{"ksize", Ops::NN::AnyValue::CreateFrom<std::vector<int64_t>>(ksize)},
                                  ...
                                  {"ceil_mode", Ops::NN::AnyValue::CreateFrom<int64_t>(ceil_mode)},
...
TEST_F(MaxPool3DTiling, MaxPool3DTiling_TreeDim)
{
    gert::StorageShape xShape = {{17, 21, 12, 7, 4}, {17, 21, 12, 7, 4}};
    gert::StorageShape yShape = {{17, 3, 2, 3, 4}, {17, 3, 2, 3, 4}};
    std::vector<int64_t> ksize = {1, 5, 4, 2, 1};
    std::vector<int64_t> strides = {1, 5, 4, 3, 1};
    std::vector<int64_t> pads = {1, 3, 3, 2, 1, 1};
    std::vector<int64_t> dilation = {1, 4, 4, 4, 5};
