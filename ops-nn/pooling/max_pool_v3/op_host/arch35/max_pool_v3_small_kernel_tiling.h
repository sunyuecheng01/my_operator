...
/*!
 * \file max_pool_v3_small_kernel_tiling.h
 * \brief
 */

#ifndef MAX_POOL_V3_NDDMA_TILING_H_
#define MAX_POOL_V3_NDDMA_TILING_H_

#include "max_pool_v3_tiling.h"

namespace optiling {
BEGIN_TILING_DATA_DEF(MaxPoolV3SmallKernelTilingData)
...
REGISTER_TILING_DATA_CLASS(MaxPoolV3_300001, MaxPoolV3SmallKernelTilingData);
REGISTER_TILING_DATA_CLASS(MaxPoolV3_300002, MaxPoolV3SmallKernelTilingData);
...
private:
    ...
    void CalcGatherMode();
    void CalcCopyMode();
    MaxPoolV3SmallKernelTilingData tilingData;
