...
class QuantUpdateScatterLargeBatchRegbase
...
public:
        ...
        const QuantUpdateScatterTilingData* tiling)
    {
        ...
        pipe_.InitBuffer(
            ...
            this->CeilAlign(
                copyBlockCount_ * tilingData_.updateOriLastDimAlign * sizeof(UpdatesType), this->BLOCK_SIZE));
        pipe_.InitBuffer(
            inQueueScales_, BUFFER_NUM,
