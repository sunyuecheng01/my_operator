...
/* !
 * \file non_zero_big_mask_dim2.h
 * \brief
 */

#ifndef CANN_NON_ZERO_BIG_MASK_DIM2_H
#define CANN_NON_ZERO_BIG_MASK_DIM2_H
...
class NonZeroBigMaskDim2 : public NonZeroBigMask<T1, T2> {
public:
...
#endif // CANN_NON_ZERO_BIG_MASK_DIM2_H