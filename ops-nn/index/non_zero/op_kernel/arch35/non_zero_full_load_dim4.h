...
/* !
 * \file non_zero_full_load_dim4.h
 * \brief
 */

#ifndef CANN_NON_ZERO_FULL_LOAD_DIM4_H
#define CANN_NON_ZERO_FULL_LOAD_DIM4_H
...
class NonZeroFullLoadDim4 : public NonZeroFullLoadBase<T1, T2, TILING_KEY> {
public:
    __aicore__ inline NonZeroFullLoadDim4(){};
...
template <typename T1, typename T2, int TILING_KEY>
__aicore__ inline void NonZeroFullLoadDim4<T1, T2, TILING_KEY>::Process()
{
    this->BaseProcess();
}
} // namespace NonZero
