...
/*!
 * \file masked_scatter_tiling_arch35.cpp
 * \brief
 */
#include "masked_scatter_tiling_arch35.h"
...
ge::graphStatus MaskedScatterTiling::CheckDataType()
{
...
ge::graphStatus MaskedScatterTiling::CheckOutputShape()
{
...
ge::graphStatus MaskedScatterTiling::GetShapeAttrsInfo()
{
...
ge::graphStatus MaskedScatterTiling::DoOpTiling()
{
...
ge::graphStatus MaskedScatterTiling::PostTiling()
{
...
void MaskedScatterTiling::DumpTilingInfo()
{
