...
/*!
 * \file test_linear_index_v2_tiling.cpp
 * \brief
 */
#include <iostream>
#include <vector>
...
class LinearIndexV2Tiling : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        std::cout << "LinearIndexV2Tiling SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "LinearIndexV2Tiling TearDown" << std::endl;
    }
};
...
TEST_F(LinearIndexV2Tiling, test_linear_index_continous)
{
    ...
    gert::StorageShape stride_shape = {
        {
            2,
        },
        {
    ...
    gert::StorageShape value_shape = {{10, 10}, {10, 10}};
    ...
    auto holder = gert::TilingContextFaker()
                      .SetOpType("LinearIndexV2")
                      .NodeIoNum(3, 1)
                      .IrInstanceNum({1, 1, 1})
                      .InputShapes({&idx_shape, &stride_shape, &value_shape})
...
TEST_F(LinearIndexV2Tiling, test_linear_index_david)
{
    std::string op_type("LinearIndexV2");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
