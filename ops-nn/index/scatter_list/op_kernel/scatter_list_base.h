    ...
    const TransposeParams& params, LocalTensor<T>& srcUbSize, LocalTensor<T>& dstUbSize)
{
    ...
    __ubuf__ T* dstLocalList1[16] = {
        dstUb + params.dst * 16, dstUb + params.dst * 17, dstUb + params.dst * 18, dstUb + params.dst * 19,
        dstUb + params.dst * 20, dstUb + params.dst * 21, dstUb + params.dst * 22, dstUb + params.dst * 23,
        dstUb + params.dst * 24, dstUb + params.dst * 25, dstUb + params.dst * 26, dstUb + params.dst * 27,
        dstUb + params.dst * 28, dstUb + params.dst * 29, dstUb + params.dst * 30, dstUb + params.dst * 31};

    transposeParams.dstHighHalf = 0;
    transposeParams.srcHighHalf = 1;
    TransDataTo5HDImpl(dstLocalList1, srcLocalList, transposeParams);

    __ubuf__ T* srcLocalList2[16] = {
        srcUb + params.src * 16, srcUb + params.src * 17, srcUb + params.src * 18, srcUb + params.src * 19,
