...
/*!
 * \file sparse4to2quant_matmul_base.h
 * \brief
 */
#ifndef SPARSE4TO2_QUANT_MATMUL_BASE_H
#define SPARSE4TO2_QUANT_MATMUL_BASE_H
...
struct SparseBlockOffset {
    ...
    uint64_t offsetSparseIndex = 0;
    uint64_t offsetC = 0;
};

// 量化mm和mc2都用的block输入信息结构体，不可随意修改
struct SparseBaseBlockArgs {
    uint64_t index;
...
#endif // SPARSE4TO2_QUANT_MATMUL_BASE_H