...
/* !
 * \file sparse4to2quant_matmul_block.h
 * \brief
 */
#ifndef SPARSE4TO2_QUANT_MATMUL_BLOCK_H
#define SPARSE4TO2_QUANT_MATMUL_BLOCK_H
...
__aicore__ inline void Sparse4to2QuantMatmulBlock::Init(const SparseQmm::Sparse4to2QuantMatmulTilingData* tilingData)
{
...
__aicore__ inline void Sparse4to2QuantMatmulBlock::UpdateBlockCnt(uint64_t mTileIndex, uint64_t nTileIndex)
{
    ...
    round_ = SparseQmm::CeilDiv(params_.totalTileCnt, static_cast<uint64_t>(matmulTilingData_->usedCoreNum));
...
__aicore__ inline void Sparse4to2QuantMatmulBlock::InitFirstTileBlockIndex()
{
...
__aicore__ inline void Sparse4to2QuantMatmulBlock::InitBlockIndex()
{
    if (indexInit_) {
...
__aicore__ inline void Sparse4to2QuantMatmulBlock::UpdateBlockIndex()
{
    if (rowOrder_ == ROW_FIRST) {
        params_.index += 1;
...
#endif // SPARSE4TO2_QUANT_MATMUL_BLOCK_H