...
struct WeightQuantBatchMatmulV2TilingMsdGroupTestParam {
    string caseName;
...
class TestWeightQuantBatchMatmulV2TilingMsdGroup
    : public testing::TestWithParam<WeightQuantBatchMatmulV2TilingMsdGroupTestParam>
{
};
...
static void TestOneParamCase(const WeightQuantBatchMatmulV2TilingMsdGroupTestParam& param)
{
...
TEST_P(TestWeightQuantBatchMatmulV2TilingMsdGroup, generalTest)
{
    WeightQuantBatchMatmulV2TilingMsdGroupTestParam param = GetParam();
...
static WeightQuantBatchMatmulV2TilingMsdGroupTestParam casesParams2448[] = {
    ...
    {"Key21_1_12288_8192_1_0_0_0_0_0_128_FLOAT16_INT4_UINT64_FLOAT16", 24, 365333139882753},
    {"Key22_1_8192_12288_1_0_0_0_0_0_128_FLOAT16_INT4_UINT64_FLOAT16", 24, 365333139882753},
    {"Key23_1_8192_24576_1_0_0_0_0_0_128_FLOAT16_INT4_UINT64_FLOAT16", 24, 365333139882753},
    {"Key24_1_4096_8192_1_0_0_0_0_0_128_FLOAT16_INT4_UINT64_FLOAT16", 24, 365333139882753},
    {"msdgroup_1_12288_1792_1_0_0_0_0_0_64_BF16_INT8_UINT64_BF16_20_40", 20, 365333139882753},
...
static void ThreadFunc(
    const WeightQuantBatchMatmulV2TilingMsdGroupTestParam* params, size_t testcase_num, size_t thread_idx,
    size_t thread_num)
{
...
static void TestMultiThread(
    const WeightQuantBatchMatmulV2TilingMsdGroupTestParam* params, size_t testcase_num, size_t thread_num)
{
...
TEST_F(TestWeightQuantBatchMatmulV2TilingMsdGroup, multi_thread_2448)
{
    // 用3个线程测试
    TestMultiThread(
        casesParams2448, sizeof(casesParams2448) / sizeof(WeightQuantBatchMatmulV2TilingMsdGroupTestParam), 3);
}
