...
struct WeightQuantBatchMatmulV2TilingMsdTestParam {
    string caseName;
...
static void TestOneParamCase(const WeightQuantBatchMatmulV2TilingMsdTestParam& param)
{
    ...
    if (testParam.size() >= 19) { // 第19个参数为innerPrecise
        innerPrecise = stol(testParam[idx++]);
    }
...
TEST_P(TestWeightQuantBatchMatmulV2TilingMsd, generalTest)
{
    WeightQuantBatchMatmulV2TilingMsdTestParam param = GetParam();
...
static WeightQuantBatchMatmulV2TilingMsdTestParam casesParams2448[] = {
    ...
    {"KeyNzCase_4_20480_5120_1_0_0_0_0_1_-1_FLOAT16_INT8_UINT64_FLOAT16_24_48_supportL0C2Out_1", 23, 358735533179649},
    {"msdCase_24_11264_6912_0_0_0_1_0_1_-1_BF16_INT8_UINT64_BF16_24_48", 24, 365057725039361},
    {"msdCase_4_3584_8192_1_0_0_0_0_1_-1_FLOAT16_INT8_UINT64_FLOAT16_24_48", 24, 365332602946305},
    {"whitecaseSplitkGroup_1_65472_65472_1_0_0_0_0_0_64_FLOAT16_INT4_UINT64_FLOAT16", 24, 356537046795009},
    {"whitecaseSplitkGroup_5_65472_32064_0_0_0_0_0_0_64_FLOAT16_INT4_UINT64_FLOAT16", 24, 356262168888065},
    {"fuzzcase_36_8192_1280_1_0_0_0_0_1_-1_FLOAT16_INT8_UINT64_FLOAT16_24_48_supportL0C2Out_0", 20, 360934556435201},
    {"fuzzcase_36_8192_1280_1_0_0_0_0_1_-1_FLOAT16_INT8_UINT64_FLOAT16_24_48_supportL0C2Out_1", 20, 363133579690753},
    {"FuzzSplitkGroup_2_65472_32064_0_0_0_0_0_0_64_FLOAT16_INT4_UINT64_FLOAT16_24_48_supportL0C2Out_1_1", 24,
     367240105955585},
};
...
TEST_F(TestWeightQuantBatchMatmulV2TilingMsd, multi_thread_2040)
{
    // 用3个线程测试
    TestMultiThread(casesParams2040, sizeof(casesParams2040) / sizeof(WeightQuantBatchMatmulV2TilingMsdTestParam), 3);
}

TEST_F(TestWeightQuantBatchMatmulV2TilingMsd, multi_thread_2448)
{
    // 用3个线程测试
