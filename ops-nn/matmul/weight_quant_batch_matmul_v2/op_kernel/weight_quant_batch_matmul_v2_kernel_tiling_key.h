...
// fixp方案
    ...
    ASCENDC_TPL_SEL(
        ASCENDC_TPL_ARGS_SEL(
            ...
            ASCENDC_TPL_UINT_SEL(TEMPLATE_EXTRA, ASCENDC_TPL_UI_LIST, PLACEHOLDER_0, WQBMMV2_TEMPLATE_EXTRA_NOT_USED),
            ASCENDC_TPL_UINT_SEL(FULL_LOAD_MODE, ASCENDC_TPL_UI_LIST, WQBMMV2_FULL_LOAD_MODE_NONE_AB_K, WQBMMV2_FULL_LOAD_MODE_NOT_USED),
#else
