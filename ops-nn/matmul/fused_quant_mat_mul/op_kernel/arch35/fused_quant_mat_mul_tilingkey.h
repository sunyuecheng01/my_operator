...
// fusion op type, RELU需对齐QBMMV3中FusedOpType枚举值
#define F_OPTYPE_NONE 0
#define F_OPTYPE_RELU 1
#define F_OPTYPE_SWIGLU 2

ASCENDC_TPL_ARGS_DECL(
    FusedQuantMatMul, ASCENDC_TPL_UINT_DECL(ATRANS, ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST, 0, 1),
    ASCENDC_TPL_UINT_DECL(BTRANS, ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST, 0, 1),
    ASCENDC_TPL_UINT_DECL(BIASMODE, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, TPL_EXCLUDE_FROM_TEMPLATE),
    ASCENDC_TPL_UINT_DECL(KERNELTYPE, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, TPL_NO_VEC_EPILOGUE_WITH_MMAPI,
                          TPL_NO_VEC_EPILOGUE_CUSTOM_GMTOABL1_WITH_MMAPI, TPL_NO_VEC_EPILOGUE_CUSTOM_GMTOAL1_WITH_MMAPI,
                          TPL_NO_VEC_EPILOGUE_CUSTOM_GMTOBL1_WITH_MMAPI),
    ASCENDC_TPL_UINT_DECL(OPTYPE, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, F_OPTYPE_NONE, F_OPTYPE_RELU, F_OPTYPE_SWIGLU));
