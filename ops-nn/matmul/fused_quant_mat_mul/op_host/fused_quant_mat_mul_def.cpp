...
public:
    explicit FusedQuantMatMul(const char *name) : OpDef(name) {
        ...
        this->Input("x2")
            .ParamType(REQUIRED)
            .DataType({ge::DT_INT8, ge::DT_INT8, ge::DT_INT8, ge::DT_INT8, ge::DT_INT4, ge::DT_INT4})
        ...
        this->Input("x2_scale")
            .ParamType(OPTIONAL)
            .DataType({ge::DT_UINT64, ge::DT_INT64, ge::DT_UINT64, ge::DT_INT64, ge::DT_UINT64, ge::DT_UINT64})
            .Format({ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND})
            .UnknownShapeFormat({ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND});
        this->Input("y_scale")
            .ParamType(OPTIONAL)
