 ...
 */
#ifndef OP_API_INC_MATMUL_COMPRESS_H_
#define OP_API_INC_MATMUL_COMPRESS_H_
...
/**
 * @brief aclnnMatmulCompress的第一段接口，根据具体的计算流程，计算workspace大小。
 * @domain aclnn_ops_infer
 */
ACLNN_API aclnnStatus aclnnMatmulCompressGetWorkspaceSize(const aclTensor* x, const aclTensor* weight,
