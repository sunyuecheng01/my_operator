...
#ifndef MATMUL_KERNEL_KERNEL_MATMUL_MIX_H
#define MATMUL_KERNEL_KERNEL_MATMUL_MIX_H
...
const int16_t AIV_SYNC_AIC_FLAG = 5;
const int16_t AIC_SYNC_AIV_FLAG = 8;
const int16_t FLAG_ID_MAX = 16;
const int16_t COUNT_ID_MAX = 15;
const int16_t COUNT_FLAG = 3;
...
public:
    ...
    using YTensorTrait = AscendC::TensorTrait<YType, AscendC::TPosition::GM, NDLayout>;
