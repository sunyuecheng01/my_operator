...
// X1维度档位点快速查找索引表{block, counts, index}
// block:待查找的base块， counts:base块可用的列表个数，index:base块对应的TABLE索引
...
// 查找BLOCK在基本块维度表中的位置信息
inline bool FindLoadBalanceInfo(uint64_t block, uint64_t& startIndex, uint64_t& count)
{
