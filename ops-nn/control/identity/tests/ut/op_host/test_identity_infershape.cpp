...
TEST_F(IdentityRTTest, infer_shape_known_success) {
  ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl("Identity"), nullptr);
  auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("Identity")->infer_shape;
