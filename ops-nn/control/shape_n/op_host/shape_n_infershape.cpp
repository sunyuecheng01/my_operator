...
namespace ops {
static ge::graphStatus InferShapeForShapeN(InferShapeContext *context) {
...
IMPL_OP_INFERSHAPE(ShapeN).InferShape(InferShapeForShapeN);
}  // namespace ops
