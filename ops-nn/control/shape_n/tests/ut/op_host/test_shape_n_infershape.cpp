...
TEST_F(SHAPE_SHAPEN_UT, TensorShapeRT2) {
  ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl("ShapeN"), nullptr);
  auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ShapeN")->infer_shape;
  ...
  EXPECT_EQ(*(holder.GetContext<gert::InferShapeContext>()->GetOutputShape(1)), gert::Shape({3}));
}
...
TEST_F(SHAPE_SHAPEN_UT, VectorShapeNRT2) {
  ...
  EXPECT_EQ(*(holder.GetContext<gert::InferShapeContext>()->GetOutputShape(1)), gert::Shape({1}));
}
...
TEST_F(SHAPE_SHAPEN_UT, ScalarShapeN) {
  ...
  EXPECT_EQ(*(holder.GetContext<gert::InferShapeContext>()->GetOutputShape(1)), gert::Shape({0}));
}

TEST_F(SHAPE_SHAPEN_UT, EmptyInput) {
  ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl("ShapeN"), nullptr);
  auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ShapeN")->infer_shape;
  gert::StorageShape output_shape_0 = {{}, {}};
  gert::StorageShape output_shape_1 = {{}, {}};
