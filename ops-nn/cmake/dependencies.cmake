...
if(DEFINED ENV{ASCEND_HOME_PATH})
  ...
  if ("$ENV{USER}" STREQUAL "root")
    if(EXISTS /usr/local/Ascend/ascend-toolkit/latest)
      ...
      set(ASCEND_DIR /usr/local/Ascend/cann)
    endif()
  else()
...
string(APPEND OPS_NN_CXX_FLAGS " -Wshadow")
string(APPEND OPS_NN_CXX_FLAGS " -Wformat=2")
string(APPEND OPS_NN_CXX_FLAGS " -fno-common")
string(APPEND OPS_NN_CXX_FLAGS " -fPIC")
if(NOT "${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
  if(ENABLE_ASAN)
    string(APPEND OPS_NN_CXX_FLAGS " -Wno-error")
  # TODO: add -Werror when fix all compile warnings
  # else()
  #   string(APPEND OPS_NN_CXX_FLAGS " -Werror")
  endif()
  string(APPEND OPS_NN_CXX_FLAGS " -Wformat-signedness")
endif()
