...
execute_process(
    COMMAND python3 ${CPACK_CMAKE_SOURCE_DIR}/scripts/package/package.py --pkg_name ops_nn --chip_name ${CPACK_SOC} --os_arch linux-${CPACK_ARCH}
...
set(NN_VERSION_OUT_PUT
    ${CPACK_CMAKE_BINARY_DIR}/ops_nn_version.h
)

configure_file(
    ${SCENE_OUT_PUT}
    ${STAGING_DIR}/share/info/ops_nn/
    COPYONLY
)
configure_file(
    ${CSV_OUTPUT}
    ${STAGING_DIR}/share/info/ops_nn/script/
    COPYONLY
)
configure_file(
    ${NN_VERSION_OUT_PUT}
...
execute_process(COMMAND bash ${MAKESELF_EXE}
        ...
        --help-header share/info/ops_nn/script/help.info
        ${makeself_param_string} share/info/ops_nn/script/install.sh
