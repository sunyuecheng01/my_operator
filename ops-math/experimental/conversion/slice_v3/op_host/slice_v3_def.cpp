...
/*!
 * \file slice_v3_def.cpp
 * \brief
 */
#include "register/op_def_registry.h"

namespace ops {
class SliceV3 : public OpDef {
public:
    explicit SliceV3(const char* name) : OpDef(name)
    {
        this->Input("x")
            .ParamType(REQUIRED)
            .DataType({ge::DT_FLOAT16, ge::DT_FLOAT, ge::DT_INT16, ge::DT_INT32, ge::DT_BF16, ge::DT_INT8, ge::DT_UINT8})
       ...
       this->Output("y")
        ...
        aicoreConfig.DynamicCompileStaticFlag(true)
            ...
            .ExtendCfgInfo("opFile.value", "slice_v3");
