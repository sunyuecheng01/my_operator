...
/*!
 * \file broadcast_v2_tiling_key.h
 * \brief broadcast_v2 tiling key declare
 */

#ifndef __BROADCAST_V2_TILING_KEY_H__
#define __BROADCAST_V2_TILING_KEY_H__
...
ASCENDC_TPL_ARGS_DECL(BroadcastV2,
