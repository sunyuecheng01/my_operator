...
#include "../op_kernel/onehot_tiling_data.h"
#include "../op_kernel/onehot_tiling_key.h"
...
static ge::graphStatus GetShapeAttrsInfo(gert::TilingContext* context, int64_t& totalIdx, ge::DataType& dataType)
{
    ...
    // dtype校验
    const std::set<ge::DataType> supportedDtype = {ge::DT_INT32};
...
// tiling 分发入口
static ge::graphStatus OnehotTilingFunc(gert::TilingContext* context)
{
    // 1、获取平台运行信息
    uint64_t ubSize;
    int64_t coreNum;
    ...
    if (totalIdx <= 0) {
        ...
        memset_s(tiling, sizeof(OnehotTilingData), 0, sizeof(OnehotTilingData));
...
// tiling注册入口.
IMPL_OP_OPTILING(Onehot).Tiling(OnehotTilingFunc).TilingParse<OnehotCompileInfo>(TilingParseForOnehot);
} // namespace optiling
