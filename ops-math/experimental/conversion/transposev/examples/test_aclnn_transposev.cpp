...
int main()
{
    ...
    CHECK_RET(ret == ACL_SUCCESS, return ret);
    LOG_PRINT("aclnnTransposevGetWorkspaceSize returned: %d\n", 888);
    ...
    // 5. 调用aclnnTransposev第二段接口
    ret = aclnnTransposev(workspaceAddr, workspaceSize, executor, stream);
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("aclnnTransposev failed. ERROR: %d\n", ret); return ret);
    ...
    std::vector<int64_t> outShape0 = {1000};
    PrintOutResult(outShape0, &outDeviceAddr);
