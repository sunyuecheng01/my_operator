...
#include <vector>
#include "acl/acl.h"
#include "aclnnop/aclnn_fill_v2.h"
...
int main()
{
    ...
    std::vector<int64_t> selfRefShape = {8, 1023};
    ...
    // 创建value aclTensor
    ret = CreateAclTensor(valueHostData, valueShape, &valueDeviceAddr, aclDataType::ACL_INT16, &value);
    CHECK_RET(ret == ACL_SUCCESS, return ret);
    ...
    ret = aclnnFillV2(workspaceAddr, workspaceSize, executor, stream);
