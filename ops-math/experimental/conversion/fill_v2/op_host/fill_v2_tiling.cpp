...
#include "../op_kernel/fill_v2_tiling_data.h"
#include "../op_kernel/fill_v2_tiling_key.h"
...
static ge::graphStatus GetShapeAttrsInfo(gert::TilingContext* context, int64_t& totalIdx, ge::DataType& dataType)
{
    ...
    // dtype校验
    const std::set<ge::DataType> supportedDtype = {ge::DT_FLOAT16, ge::DT_FLOAT, ge::DT_INT16, ge::DT_INT32, ge::DT_BF16};
...
static ge::graphStatus FillV2TilingFunc(gert::TilingContext* context)
{
    // 1、获取平台运行信息
    uint64_t ubSize = 0;
    int64_t coreNum = 0;
    ...
    // 4、设置tiling信息
    FillV2TilingData* tiling = context->GetTilingData<FillV2TilingData>();
    OP_CHECK_NULL_WITH_CONTEXT(context, tiling);
    OP_CHECK_IF(memset_s(tiling, sizeof(FillV2TilingData), 0, sizeof(FillV2TilingData)) != EOK,
...
static ge::graphStatus TilingParseForFillV2([[maybe_unused]] gert::TilingParseContext* context)
{ 
    return ge::GRAPH_SUCCESS;  
}

IMPL_OP_OPTILING(FillV2).Tiling(FillV2TilingFunc).TilingParse<FillV2CompileInfo>(TilingParseForFillV2);
} // namespace optiling
