...
public:
    ...
    __aicore__ inline void Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, GM_ADDR workspace, const MulV2TilingData* tilingData);
...
template <typename T>
__aicore__ inline void MulV2<T>::Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, GM_ADDR workspace,const MulV2TilingData* tilingData)
{
