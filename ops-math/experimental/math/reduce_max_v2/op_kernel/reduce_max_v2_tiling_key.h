...
/*!
 * \file reduce_max_v2_tiling_key.h
 * \brief reduce max v2 tiling key declare
*/

#ifndef _REDUCE_MAX_V2_TILING_KEY_H__
#define _REDUCE_MAX_V2_TILING_KEY_H__
...
ASCENDC_TPL_ARGS_DECL(ReduceMaxV2,
