...
#include "add_v2_tiling_data.h"
#include "add_v2_tiling_key.h"
...
class AddV2 {
public:
    __aicore__ inline AddV2(){};

    __aicore__ inline void Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, const AddV2TilingData* tilingData);
...
template <typename T>
__aicore__ inline void AddV2<T>::Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, const AddV2TilingData* tilingData)
{
...
template <typename T>
__aicore__ inline void AddV2<T>::CopyIn(int32_t progress)
{
...
template <typename T>
__aicore__ inline void AddV2<T>::CopyOut(int32_t progress)
{
...
template <typename T>
__aicore__ inline void AddV2<T>::Compute(int32_t progress)
{
...
template <typename T>
__aicore__ inline void AddV2<T>::Process()
{
