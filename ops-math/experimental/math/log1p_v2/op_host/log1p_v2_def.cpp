...
namespace ops {
class Log1pV2 : public OpDef {
public:
    explicit Log1pV2(const char* name) : OpDef(name)
    {
        ...
        aicoreConfig.DynamicCompileStaticFlag(true)
            ...
            .ExtendCfgInfo("opFile.value", "log1p_v2");    // 这里制定的值会对应到kernel入口文件名.cpp
        this->AICore().AddConfig("ascend910b", aicoreConfig); // 其他的soc版本补充部分配置项
    }
};
OP_ADD(Log1pV2); // 添加算子信息库
} // namespace ops