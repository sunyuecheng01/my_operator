...
/*!
 * \file minimum_tiling_key.h
 * \brief minimum tiling key declare
*/

#ifndef __MINIMUM_TILING_KEY_H__
#define __MINIMUM_TILING_KEY_H__
...
ASCENDC_TPL_ARGS_DECL(minimum,
    ASCENDC_TPL_UINT_DECL(schMode, 3, 
    ASCENDC_TPL_UI_LIST, 
