...
/*!
 * \file maximum_v2_tiling_key.h
 * \brief maximum_v2 tiling key declare
*/
#ifndef __MAXIMUMV2_TILING_KEY_H__
#define __MAXIMUMV2_TILING_KEY_H__
...
ASCENDC_TPL_ARGS_DECL(MaximumV2,
