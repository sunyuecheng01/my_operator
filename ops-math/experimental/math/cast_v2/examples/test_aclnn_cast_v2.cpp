...
int main()
{
    ...
    CHECK_RET(ret == ACL_SUCCESS, return ret);
    LOG_PRINT("aclnnCastV2GetWorkspaceSize returned: %d\n", 888);
    ...
    // 5. 调用aclnnCastV2第二段接口
    ret = aclnnCastV2(workspaceAddr, workspaceSize, executor, stream);
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("aclnnCastV2 failed. ERROR: %d\n", ret); return ret);
