...
/*!
 * \file reduce_sum_v2_tiling_key.h
 * \brief reduce sum v2 tiling key declare
*/

#ifndef _REDUCE_SUM_V2_TILING_KEY_H__
#define _REDUCE_SUM_V2_TILING_KEY_H__
...
ASCENDC_TPL_ARGS_DECL(ReduceSumV2,
