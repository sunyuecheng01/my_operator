...
* @li x1: A Tensor. Must be one of the following types: float32,float16,int32,int16,bfloat16.
* @li x2: A Tensor. Must be one of the following types: float32,float16,int32,int16,bfloat16. \n

*@par Outputs:
*y: A Tensor. Must be one of the following types: float32,float16,int32,int16,bfloat16.
...
#endif // OPS_OP_PROTO_INC_DIV_V2_H_