...
#include <vector>
#include "acl/acl.h"
#include "aclnn_ger_v2.h"
#include "acl/acl_base.h"
#include <string>
inline std::string AscendErrStr() { return aclGetRecentErrMsg(); }
// 修改测试数据类型
...
int main()
{
    ...
    std::vector<int64_t> selfXShape = {8};
    std::vector<DataType> selfXHostData(8, 2);
    ...
    std::vector<DataType> selfYHostData(3, 3);
    ...
    ret = aclnnGerV2(workspaceAddr, workspaceSize, executor, stream);
