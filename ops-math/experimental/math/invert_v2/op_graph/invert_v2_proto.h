...
/**
*@brief Returns invert (x)
*@par Inputs:
*Two inputs, including:
* @li x1: A NCHW or NHWC Tensor. Must be one of the following types: DT_INT16，DT_UINT16.

*@par Outputs:
*y: A NCHW or NHWC Tensor. Must be one of the following types: DT_INT16，DT_UINT16.
...
#endif // OPS_OP_PROTO_INC_INVERTV2_H_