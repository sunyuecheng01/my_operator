...
/*!
 * \file reduce_min_v2_tiling_key.h
 * \brief reduce min v2 tiling key declare
*/

#ifndef __REDUCE_MIN_V2_TILING_KEY_H__
#define __REDUCE_MIN_V2_TILING_KEY_H__
...
ASCENDC_TPL_ARGS_DECL(ReduceMinV2,
