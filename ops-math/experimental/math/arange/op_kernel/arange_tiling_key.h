...
/*!
 * \file arange_tiling_key.h
 * \brief arange tiling key declare
 */

#ifndef __ARANGE_TILING_KEY_H__
#define __ARANGE_TILING_KEY_H__
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_UINT_SEL(schMode, ASCENDC_TPL_UI_LIST, ELEMENTWISE_TPL_SCH_MODE_1)),
);
