 ...
 * \brief
 */
#ifndef __SQUARE_V2_H__
#define __SQUARE_V2_H__

#include "kernel_operator.h"
#include "kernel_tiling/kernel_tiling.h"
#include "square_v2_tiling_data.h"
#include "square_v2_tiling_key.h"

namespace NsSquareV2 {
    ...
    class SquareV2 {
    public:
        __aicore__ inline SquareV2(){};
    
        __aicore__ inline void Init(GM_ADDR x, GM_ADDR z, const SquareV2TilingData* tilingData);
    ...
    template <typename T>
    __aicore__ inline void SquareV2<T>::Init(GM_ADDR x, GM_ADDR z, const SquareV2TilingData* tilingData)
    {
    ...
    template <typename T>
    __aicore__ inline void SquareV2<T>::CopyIn(int32_t progress)
    {
    ...
    template <typename T>
    __aicore__ inline void SquareV2<T>::CopyOut(int32_t progress)
    {
    ...
    template <typename T>
    __aicore__ inline void SquareV2<T>::Compute(int32_t progress)
    {
    ...
    template <typename T>
    __aicore__ inline void SquareV2<T>::Process()
    {
