...
#include "../op_kernel/square_v2_tiling_data.h"
#include "../op_kernel/square_v2_tiling_key.h"
...
namespace optiling {
    ...
    static ge::graphStatus GetShapeAttrsInfo(gert::TilingContext* context, int64_t& totalIdx, ge::DataType& dataType)
    {
        ...
        OP_CHECK_IF(
            !shapeMatch,
            OP_LOGE(
                context, "SquareV2: inputx,outputz shape not match! dim num: x=%zu,  z=%zu",
    ...
    // tiling 分发入口
    // 可直接替换你的 SquareV2TilingFunc 内部实现（保留函数签名）
    static ge::graphStatus SquareV2TilingFunc(gert::TilingContext* context)
    {
        ...
        OP_CHECK_IF(memset_s(tiling, sizeof(SquareV2TilingData), 0, sizeof(SquareV2TilingData)) != EOK,
