...
int main()
{
    ...
    // 5. 调用aclnnTruncV2第二段接口
    ret = aclnnTruncV2(workspaceAddr, workspaceSize, executor, stream);
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("aclnnTruncV2 failed. ERROR: %d\n", ret); return ret);
