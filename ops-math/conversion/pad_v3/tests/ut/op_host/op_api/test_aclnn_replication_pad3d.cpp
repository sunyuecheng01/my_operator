...
#include "../../../../op_host/op_api/aclnn_replication_pad3d.h"
...
class replication_pad3d_test : public testing::Test {
 protected:
  static void SetUpTestCase() { std::cout << "replication_pad3d_test SetUp" << std::endl; }

  static void TearDownTestCase() { std::cout << "replication_pad3d_test TearDown" << std::endl; }
};

TEST_F(replication_pad3d_test, case_1) {
  ...
  auto ut = OP_API_UT(aclnnReplicationPad3d, INPUT(self_tensor_desc, padding_desc),
                                                    OUTPUT(out_desc));
...
TEST_F(replication_pad3d_test, case_2) {
...
TEST_F(replication_pad3d_test, case_3) {
  auto self_tensor_desc = TensorDesc({1, 1, 2, 2, 2}, ACL_FLOAT16, ACL_FORMAT_ND);
  auto padding_desc = IntArrayDesc(vector<int64_t>{1, 1, 1, 1, 1, 1});
  auto out_desc = TensorDesc({1, 1, 4, 4, 4}, ACL_FLOAT16, ACL_FORMAT_ND);

  auto ut = OP_API_UT(aclnnReplicationPad3d, INPUT(nullptr, padding_desc),
                                                OUTPUT(out_desc));
  ...
  auto ut_2 = OP_API_UT(aclnnReplicationPad3d, INPUT(self_tensor_desc, nullptr),
                                                OUTPUT(out_desc));
  workspace_size = 0;
...
// CheckNotNull out
TEST_F(replication_pad3d_test, case_4) {
  auto self_tensor_desc = TensorDesc({1, 1, 2, 2, 2}, ACL_FLOAT16, ACL_FORMAT_ND);
  auto padding_desc = IntArrayDesc(vector<int64_t>{1, 1, 1, 1, 1, 1});
...
TEST_F(replication_pad3d_test, case_5)
{
  auto self_tensor_desc = TensorDesc({1, 1, 2, 2, 2}, ACL_FLOAT16, ACL_FORMAT_ND);
...
// CheckShape self dim
TEST_F(replication_pad3d_test, case_6)
{
...
TEST_F(replication_pad3d_test, case_7)
{
...
TEST_F(replication_pad3d_test, case_8)
{
...
// CheckDtype support
TEST_F(replication_pad3d_test, case_9)
{
...
TEST_F(replication_pad3d_test, case_10)
{
...
TEST_F(replication_pad3d_test, case_11)
{
  auto self_tensor_desc = TensorDesc({1, 1, 2, 2, 2}, ACL_FLOAT16, ACL_FORMAT_ND);
  auto padding_desc = IntArrayDesc(vector<int64_t>{1, 1, 1, 1, 1, 1});
...
TEST_F(replication_pad3d_test, case_12)
{
  auto self_tensor_desc = TensorDesc({1, 1, 2, 2, 2}, ACL_FLOAT16, ACL_FORMAT_ND);
  auto padding_desc = IntArrayDesc(vector<int64_t>{1, 1, 1, 1, 1, 1});
...
TEST_F(replication_pad3d_test, case_13) {
...
TEST_F(replication_pad3d_test, case_14) {
...
TEST_F(replication_pad3d_test, case_15) {
...
TEST_F(replication_pad3d_test, case_16) {
  auto self_tensor_desc = TensorDesc({2, 1, 2, 2, 2}, ACL_FLOAT16, ACL_FORMAT_ND);
  auto padding_desc = IntArrayDesc(vector<int64_t>{1, 1, 1, 1, 1, 1});
