...
#include "../../../../op_host/op_api/aclnn_reflection_pad1d.h"
...
TEST_F(reflection_pad1d_test, case_2)
{
...
TEST_F(reflection_pad1d_test, case_3)
{
    auto self_tensor_desc = TensorDesc({1, 3}, ACL_FLOAT16, ACL_FORMAT_ND);
    auto padding_desc = IntArrayDesc(vector<int64_t>{2, 2});
    auto out_desc = TensorDesc({1, 7}, ACL_FLOAT16, ACL_FORMAT_ND);

    auto ut = OP_API_UT(aclnnReflectionPad1d, INPUT(nullptr, padding_desc), OUTPUT(out_desc));
    ...
    auto ut_2 = OP_API_UT(aclnnReflectionPad1d, INPUT(self_tensor_desc, nullptr), OUTPUT(out_desc));
    workspace_size = 0;
...
// CheckNotNull out
TEST_F(reflection_pad1d_test, case_4)
{
    auto self_tensor_desc = TensorDesc({1, 3}, ACL_FLOAT16, ACL_FORMAT_ND);
    auto padding_desc = IntArrayDesc(vector<int64_t>{2, 2});

    auto ut = OP_API_UT(aclnnReflectionPad1d, INPUT(self_tensor_desc, padding_desc), OUTPUT(nullptr));
...
TEST_F(reflection_pad1d_test, case_5)
{
    auto self_tensor_desc = TensorDesc({1, 3}, ACL_FLOAT16, ACL_FORMAT_ND);
...
// CheckShape self dim
TEST_F(reflection_pad1d_test, case_6)
{
...
TEST_F(reflection_pad1d_test, case_7)
{
    auto self_tensor_desc = TensorDesc({1, 3}, ACL_FLOAT16, ACL_FORMAT_ND);
    auto padding_desc = IntArrayDesc(vector<int64_t>{2, 2});
...
TEST_F(reflection_pad1d_test, case_8)
{
...
// CheckDtype support
TEST_F(reflection_pad1d_test, case_9)
{
...
TEST_F(reflection_pad1d_test, case_12)
{
    auto self_tensor_desc = TensorDesc({1, 2}, ACL_FLOAT16, ACL_FORMAT_ND);
    auto padding_desc = IntArrayDesc(vector<int64_t>{2, 2});
    auto out_desc = TensorDesc({1, 6}, ACL_FLOAT16, ACL_FORMAT_ND);
...
// CheckShape padding dim value chw
TEST_F(reflection_pad1d_test, case_13)
{
    auto self_tensor_desc = TensorDesc({1, 1, 2}, ACL_FLOAT16, ACL_FORMAT_ND);
    auto padding_desc = IntArrayDesc(vector<int64_t>{2, 2});
    auto out_desc = TensorDesc({1, 1, 6}, ACL_FLOAT16, ACL_FORMAT_ND);
...
TEST_F(reflection_pad1d_test, case_14)
{
    auto self_tensor_desc = TensorDesc({1, 3}, ACL_FLOAT16, ACL_FORMAT_ND);
    auto padding_desc = IntArrayDesc(vector<int64_t>{2, 2});
...
TEST_F(reflection_pad1d_test, case_15)
{
...
TEST_F(reflection_pad1d_test, case_16)
{
...
TEST_F(reflection_pad1d_test, case_17)
{
    auto self_tensor_desc = TensorDesc({10, 0}, ACL_FLOAT16, ACL_FORMAT_ND);
    auto padding_desc = IntArrayDesc(vector<int64_t>{2, 2});
    auto out_desc = TensorDesc({10, 4}, ACL_FLOAT16, ACL_FORMAT_ND);
    auto ut = OP_API_UT(aclnnReflectionPad1d, INPUT(self_tensor_desc, padding_desc), OUTPUT(out_desc));
...
TEST_F(reflection_pad1d_test, ascend910B2_case_18)
{
    auto self_tensor_desc = TensorDesc({1, 3}, ACL_BF16, ACL_FORMAT_ND);
    auto padding_desc = IntArrayDesc(vector<int64_t>{2, 2});
    auto out_desc = TensorDesc({1, 7}, ACL_BF16, ACL_FORMAT_ND);
