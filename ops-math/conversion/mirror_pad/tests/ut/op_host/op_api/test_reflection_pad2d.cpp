...
#include "../../../../op_host/op_api/aclnn_reflection_pad2d.h"
...
class reflection_pad2d_test : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "reflection_pad2d_test SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "reflection_pad2d_test TearDown" << std::endl;
    }
};

TEST_F(reflection_pad2d_test, case_1)
{
    ...
    auto ut = OP_API_UT(aclnnReflectionPad2d, INPUT(self_tensor_desc, padding_desc), OUTPUT(out_desc));
...
TEST_F(reflection_pad2d_test, case_2)
{
...
TEST_F(reflection_pad2d_test, case_3)
{
    ...
    auto ut_2 = OP_API_UT(aclnnReflectionPad2d, INPUT(self_tensor_desc, nullptr), OUTPUT(out_desc));
    workspace_size = 0;
...
// CheckNotNull out
TEST_F(reflection_pad2d_test, case_4)
{
    auto self_tensor_desc = TensorDesc({2, 4, 3}, ACL_FLOAT16, ACL_FORMAT_ND);
    auto padding_desc = IntArrayDesc(vector<int64_t>{2, 2, 2, 2});

    auto ut = OP_API_UT(aclnnReflectionPad2d, INPUT(self_tensor_desc, padding_desc), OUTPUT(nullptr));
...
TEST_F(reflection_pad2d_test, case_5)
{
    auto self_tensor_desc = TensorDesc({2, 4, 3}, ACL_FLOAT16, ACL_FORMAT_ND);
...
// CheckShape self dim
TEST_F(reflection_pad2d_test, case_6)
{
...
TEST_F(reflection_pad2d_test, case_7)
{
    auto self_tensor_desc = TensorDesc({1, 4, 3}, ACL_FLOAT16, ACL_FORMAT_ND);
    auto padding_desc = IntArrayDesc(vector<int64_t>{2, 2, 2, 2});
    auto out_desc = TensorDesc({1, 1, 4, 3}, ACL_FLOAT16, ACL_FORMAT_ND);
...
TEST_F(reflection_pad2d_test, case_8)
{
...
// CheckDtype not support self
TEST_F(reflection_pad2d_test, case_10)
{
    auto self_tensor_desc = TensorDesc({1, 1, 4, 3}, ACL_UINT16, ACL_FORMAT_ND);
    auto padding_desc = IntArrayDesc(vector<int64_t>{2, 2, 2, 2});
    auto out_desc = TensorDesc({1, 1, 8, 7}, ACL_FLOAT16, ACL_FORMAT_ND);
...
// CheckDtype not support out
TEST_F(reflection_pad2d_test, case_11)
{
    auto self_tensor_desc = TensorDesc({1, 1, 4, 3}, ACL_FLOAT16, ACL_FORMAT_ND);
    auto padding_desc = IntArrayDesc(vector<int64_t>{2, 2, 2, 2});
    auto out_desc = TensorDesc({1, 1, 8, 7}, ACL_UINT16, ACL_FORMAT_ND);
...
TEST_F(reflection_pad2d_test, case_12)
{
    auto self_tensor_desc = TensorDesc({1, 1, 4, 3}, ACL_FLOAT16, ACL_FORMAT_ND);
    auto padding_desc = IntArrayDesc(vector<int64_t>{2, 2, 2, 2});
...
TEST_F(reflection_pad2d_test, case_14)
{
    auto self_tensor_desc = TensorDesc({1, 2, 4}, ACL_FLOAT16, ACL_FORMAT_ND);
...
TEST_F(reflection_pad2d_test, case_15)
{
    auto self_tensor_desc = TensorDesc({3, 0, 10}, ACL_FLOAT16, ACL_FORMAT_ND);
    auto padding_desc = IntArrayDesc(vector<int64_t>{2, 2, 2, 2});
    auto out_desc = TensorDesc({3, 4, 14}, ACL_FLOAT16, ACL_FORMAT_ND);
    auto ut = OP_API_UT(aclnnReflectionPad2d, INPUT(self_tensor_desc, padding_desc), OUTPUT(out_desc));
...
TEST_F(reflection_pad2d_test, case_17)
{
...
TEST_F(reflection_pad2d_test, ascend910B2_case_18)
{
    auto self_tensor_desc = TensorDesc({1, 1, 4, 3}, ACL_BF16, ACL_FORMAT_ND);
    auto padding_desc = IntArrayDesc(vector<int64_t>{2, 2, 2, 2});
    auto out_desc = TensorDesc({1, 1, 8, 7}, ACL_BF16, ACL_FORMAT_ND);
