...
#include "nn_other.h"
#include "../op_graph/split_proto.h"
...
#define ADD_OUTPUT(outputIndex, outputName, outputDtype, outputShape)                                           \
    do {                                                                                                        \
        ...
        split1.update_output_desc_##outputName(outputName##outputIndex##_desc);                                  \
    } while (0)

#define ADD_INPUT_ATTR(attrName, attrValue) split1.set_attr_##attrName(attrValue)
