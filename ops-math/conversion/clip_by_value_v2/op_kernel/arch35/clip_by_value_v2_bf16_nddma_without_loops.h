...
/*!
 * \file clip_by_value_v2_bf16_nddma_without_loops.h
 * \brief
 */

#ifndef ASCENDC_CLIP_BY_VALUE_V2_BF16_NDDMA_WITHOUT_LOOPS_H_
#define ASCENDC_CLIP_BY_VALUE_V2_BF16_NDDMA_WITHOUT_LOOPS_H_
...
class ClipByValueV2Bf16NddmaWithoutLoops {
public:
    __aicore__ inline ClipByValueV2Bf16NddmaWithoutLoops(){};
        ...
        const ClipByValueTilingData* tilingDataPtr, TPipe* pipePtr)
    {
        ...
        inputGmClipValueMin_.SetGlobalBuffer((__gm__ bfloat16_t*)clipValueMin);
        inputGmClipValueMax_.SetGlobalBuffer((__gm__ bfloat16_t*)clipValueMax);
...
private:
    ...
    GlobalTensor<bfloat16_t> inputGmClipValueMin_;
    GlobalTensor<bfloat16_t> inputGmClipValueMax_;
...
#endif // ASCENDC_CLIP_BY_VALUE_V2_BF16_NDDMA_WITHOUT_LOOPS_H_