...
/*!
 * \file clip_by_value_v2_f32_nddma_without_loops.h
 * \brief
 */

#ifndef ASCENDC_CLIP_BY_VALUE_V2_F32_NDDMA_WITHOUT_LOOPS_H_
#define ASCENDC_CLIP_BY_VALUE_V2_F32_NDDMA_WITHOUT_LOOPS_H_
...
class ClipByValueV2F32NddmaWithoutLoops {
public:
    __aicore__ inline ClipByValueV2F32NddmaWithoutLoops(){};
        ...
        const ClipByValueTilingData* tilingDataPtr, TPipe* pipePtr)
    {
        ...
        inputGmClipValueMin_.SetGlobalBuffer((__gm__ float*)clipValueMin);
        inputGmClipValueMax_.SetGlobalBuffer((__gm__ float*)clipValueMax);
...
private:
    ...
    GlobalTensor<float> inputGmClipValueMin_;
    GlobalTensor<float> inputGmClipValueMax_;
...
#endif // ASCENDC_CLIP_BY_VALUE_V2_F32_NDDMA_WITHOUT_LOOPS_H_