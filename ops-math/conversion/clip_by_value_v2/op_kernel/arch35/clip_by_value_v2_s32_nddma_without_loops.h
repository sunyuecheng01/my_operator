...
/*!
 * \file clip_by_value_v2_s32_nddma_without_loops.h
 * \brief
 */
#ifndef ASCENDC_CLIP_BY_VALUE_V2_S32_NDDMA_WITHOUT_LOOPS_H_
#define ASCENDC_CLIP_BY_VALUE_V2_S32_NDDMA_WITHOUT_LOOPS_H_
...
class ClipByValueV2S32NddmaWithoutLoops {
public:
    __aicore__ inline ClipByValueV2S32NddmaWithoutLoops(){};
        ...
        const ClipByValueTilingData* tilingDataPtr, TPipe* pipePtr)
    {
        ...
        inputGmX_.SetGlobalBuffer((__gm__ int32_t*)x);
        inputGmClipValueMin_.SetGlobalBuffer((__gm__ int32_t*)clipValueMin);
        inputGmClipValueMax_.SetGlobalBuffer((__gm__ int32_t*)clipValueMax);
        outputGmY_.SetGlobalBuffer((__gm__ int32_t*)y);
...
private:
    ...
    __aicore__ inline void CopyIn2(
        int64_t ubSplitSize, const int64_t (&axesIndices)[Ops::Base::BROADCAST_MAX_DIMS], int64_t ubLoopIdx)
    {
        bufferIn2_ = queIn2_.AllocTensor<int32_t>();
        ...
        queIn2_.EnQue<int32_t>(bufferIn2_);
    }
    ...
    __aicore__ inline void Compute3(int64_t ubSplitSize, const int64_t (&axesIndices)[Ops::Base::BROADCAST_MAX_DIMS])
    {
        ...
        bufferIn2_ = queIn2_.DeQue<int32_t>();
...
private:
    ...
    GlobalTensor<int32_t> inputGmX_;
    GlobalTensor<int32_t> inputGmClipValueMin_;
    GlobalTensor<int32_t> inputGmClipValueMax_;
    GlobalTensor<int32_t> outputGmY_;
    ...
    LocalTensor<int32_t> bufferIn2_;
    LocalTensor<int32_t> bufferOut0_;
};

} // namespace ClipByValueV2
#endif // ASCENDC_CLIP_BY_VALUE_V2_S32_NDDMA_WITHOUT_LOOPS_H_