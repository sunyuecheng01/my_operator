 ...
 */
ACLNN_API aclnnStatus aclnnCircularPad2dBackwardGetWorkspaceSize(
...
aclnnCircularPad2dBackward(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, aclrtStream stream);
#ifdef __cplusplus
}
#endif

#endif // OP_API_INC_CIRCULAR_PAD2D_BACKWARD_H_