...
/*!
 * \file slice_move_align_last_dim.h
 * \brief
 */
#ifndef SLICE_MOVE_ALIGN_LAST_DIM_H
#define SLICE_MOVE_ALIGN_LAST_DIM_H
...
public:
    ...
    __aicore__ inline void Init(GM_ADDR x, GM_ADDR begin, GM_ADDR end, GM_ADDR strides, GM_ADDR y,
                                const SliceMoveAlignLastDimTilingData* tilingData, TPipe* pipeIn);
                                                      ...
                                                      GM_ADDR y, const SliceMoveAlignLastDimTilingData* tilingData, TPipe* pipeIn)
{
    ...
    this->ParseBaseTilingData(begin, &(tilingData->sliceBaseTilingData), blockIdx_);
...
#endif // SLICE_MOVE_ALIGN_LAST_DIM_H