...
/*!
 * \file clip_by_value_f16_nddma_without_loops.h
 * \brief
 */

#ifndef ASCENDC_CLIP_BY_VALUE_F16_NDDMA_WITHOUT_LOOPS_H_
#define ASCENDC_CLIP_BY_VALUE_F16_NDDMA_WITHOUT_LOOPS_H_
...
class ClipByValueF16NddmaWithoutLoops {
public:
    __aicore__ inline ClipByValueF16NddmaWithoutLoops(){};
...
#endif // ASCENDC_CLIP_BY_VALUE_F16_NDDMA_WITHOUT_LOOPS_H_