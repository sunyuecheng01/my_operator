...
/*!
 * \file clip_by_value_f32_nddma_without_loops.h
 * \brief
 */

#ifndef ASCENDC_CLIP_BY_VALUE_F32_NDDMA_WITHOUT_LOOPS_H_
#define ASCENDC_CLIP_BY_VALUE_F32_NDDMA_WITHOUT_LOOPS_H_
...
class ClipByValueF32NddmaWithoutLoops {
public:
    __aicore__ inline ClipByValueF32NddmaWithoutLoops(){};
...
#endif // ASCENDC_CLIP_BY_VALUE_F32_NDDMA_WITHOUT_LOOPS_H_