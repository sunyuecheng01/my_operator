...
class GreaterEqual : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "GreaterEqual SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "GreaterEqual TearDown" << std::endl;
  }
};
    ...
    ge::graphStatus testCaseResult = ge::GRAPH_SUCCESS)
{
    ...
    auto inferShapeFunc = spaceRegistry->GetOpImpl("GreaterEqual")->infer_shape;
...
TEST_F(GreaterEqual, greaterEqual_infershape_case_0)
{
