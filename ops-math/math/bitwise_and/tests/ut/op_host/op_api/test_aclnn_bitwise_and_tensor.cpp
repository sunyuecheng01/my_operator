...
#include "math/bitwise_and/op_api/aclnn_bitwise_and_tensor.h"
...
class l2_bitwise_and_tensor_test : public testing::Test {
 protected:
...
TEST_F(l2_bitwise_and_tensor_test, case_int16) {
  ...
  auto ut = OP_API_UT(aclnnBitwiseAndTensor, INPUT(self_tensor_desc, other_tensor_desc), OUTPUT(out_tensor_desc));
...
TEST_F(l2_bitwise_and_tensor_test, case_int32) {
...
TEST_F(l2_bitwise_and_tensor_test, case_int64) {
...
TEST_F(l2_bitwise_and_tensor_test, case_int8) {
...
TEST_F(l2_bitwise_and_tensor_test, case_uint8) {
...
TEST_F(l2_bitwise_and_tensor_test, case_uint16) {
...
TEST_F(l2_bitwise_and_tensor_test, case_bool) {
...
TEST_F(l2_bitwise_and_tensor_test, case_suppport_format) {
  ...
  auto ut1 = OP_API_UT(aclnnBitwiseAndTensor, INPUT(self_tensor_desc, other_tensor_desc), OUTPUT(out_tensor_desc));
  ...
  auto ut2 = OP_API_UT(aclnnBitwiseAndTensor, INPUT(self_tensor_desc, other_tensor_desc), OUTPUT(out_tensor_desc));
  ...
  auto ut3 = OP_API_UT(aclnnBitwiseAndTensor, INPUT(self_tensor_desc, other_tensor_desc), OUTPUT(out_tensor_desc));
  ...
  auto ut4 = OP_API_UT(aclnnBitwiseAndTensor, INPUT(self_tensor_desc, other_tensor_desc), OUTPUT(out_tensor_desc));
...
TEST_F(l2_bitwise_and_tensor_test, case_nullptr) {
  auto tensor_desc = TensorDesc({2, 3, 4, 5}, ACL_INT16, ACL_FORMAT_ND);

  auto ut = OP_API_UT(aclnnBitwiseAndTensor, INPUT((aclTensor*)nullptr, (aclTensor*)nullptr), OUTPUT(tensor_desc));
...
// 空tensor
TEST_F(l2_bitwise_and_tensor_test, case_empty) {
  auto self_tensor_desc = TensorDesc({0}, ACL_INT32, ACL_FORMAT_ND);
  auto other_tensor_desc = TensorDesc({0}, ACL_INT32, ACL_FORMAT_ND);
  auto out_tensor_desc = TensorDesc(self_tensor_desc);
...
TEST_F(l2_bitwise_and_tensor_test, case_errtype) {
...
// CheckNotNull
TEST_F(l2_bitwise_and_tensor_test, case_nullptr2) {
  auto tensor_desc = TensorDesc({10, 5}, ACL_INT32, ACL_FORMAT_ND);

  auto ut_2 = OP_API_UT(aclnnBitwiseAndTensor, INPUT(nullptr, tensor_desc), OUTPUT(tensor_desc));
  // SAMPLE: only test GetWorkspaceSize
  uint64_t workspace_size = 0;
  aclnnStatus aclRet = ut_2.TestGetWorkspaceSize(&workspace_size);
  EXPECT_EQ(aclRet, ACLNN_ERR_PARAM_NULLPTR);

  auto ut_3 = OP_API_UT(aclnnBitwiseAndTensor, INPUT(tensor_desc, nullptr), OUTPUT(tensor_desc));
  // SAMPLE: only test GetWorkspaceSize
  aclRet = ut_3.TestGetWorkspaceSize(&workspace_size);
  EXPECT_EQ(aclRet, ACLNN_ERR_PARAM_NULLPTR);

  auto ut_4 = OP_API_UT(aclnnBitwiseAndTensor, INPUT(tensor_desc, tensor_desc), OUTPUT(nullptr));
  // SAMPLE: only test GetWorkspaceSize
...
// CheckDtypeValid
TEST_F(l2_bitwise_and_tensor_test, case_dtype_uint32) {
  //uint32
  auto tensor_desc = TensorDesc({10, 5}, ACL_UINT32, ACL_FORMAT_ND);

  auto ut = OP_API_UT(aclnnBitwiseAndTensor, INPUT(tensor_desc, tensor_desc), OUTPUT(tensor_desc));
  ...
  auto ut_3 = OP_API_UT(aclnnBitwiseAndTensor, INPUT(tensor_desc, tensor_desc), OUTPUT(tensor_desc));
  ...
  auto ut_4 = OP_API_UT(aclnnBitwiseAndTensor, INPUT(tensor_desc, tensor_desc), OUTPUT(tensor_desc));
...
// CheckShape
TEST_F(l2_bitwise_and_tensor_test, case_shape) {
  ...
  auto ut_2 = OP_API_UT(aclnnBitwiseAndTensor, INPUT(self_tensor_desc, other_tensor_desc), OUTPUT(out_tensor_desc));
...
// CheckFormat
TEST_F(l2_bitwise_and_tensor_test, case_format) {
  ...
  auto ut_1 = OP_API_UT(aclnnBitwiseAndTensor, INPUT(self_tensor_desc, other_tensor_desc), OUTPUT(out_tensor_desc));
  ...
  auto ut_2 = OP_API_UT(aclnnBitwiseAndTensor, INPUT(tensor_desc, tensor_desc), OUTPUT(tensor_desc));
...
// uncontiguous
TEST_F(l2_bitwise_and_tensor_test, case_uncontiguous) {
    ...
    auto ut = OP_API_UT(aclnnBitwiseAndTensor, INPUT(self_tensor_desc, self_tensor_desc), OUTPUT(out_tensor_desc));
    // SAMPLE: only test GetWorkspaceSize
    uint64_t workspace_size = 0;
    aclnnStatus aclRet = ut.TestGetWorkspaceSize(&workspace_size);
    EXPECT_EQ(aclRet, ACL_SUCCESS);
...
TEST_F(l2_bitwise_and_tensor_test, case_inplace_teset) {
  vector<aclDataType> dtype_list{ACL_INT8, ACL_INT32, ACL_UINT8, ACL_INT16,
                                 ACL_INT64, ACL_BOOL};
  for (auto dtype : dtype_list) {
    auto tensor_1_desc = TensorDesc({3, 5}, dtype, ACL_FORMAT_ND);
    auto tensor_2_desc = TensorDesc({3, 5}, dtype, ACL_FORMAT_ND);

    int64_t dim = 0;
    auto ut = OP_API_UT(aclnnInplaceBitwiseAndTensor, INPUT(tensor_1_desc, tensor_2_desc), OUTPUT());
    uint64_t workspace_size = 0;
    aclnnStatus aclRet = ut.TestGetWorkspaceSize(&workspace_size);
