 ...
 */
ACLNN_API aclnnStatus aclnnBatchNormStatsGetWorkspaceSize(
...
aclnnBatchNormStats(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, const aclrtStream stream);
