...
#include "../../../../op_host/arch35/greater_tiling_arch35.h"

using namespace std;
using namespace ge;

class GreaterTilingTest : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "GreaterTilingTest SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "GreaterTilingTest TearDown" << std::endl;
  }
};
