...
#ifndef CANN_CUSTOM_OPS_LOG_STRUCT_H_
#define CANN_CUSTOM_OPS_LOG_STRUCT_H_
namespace LogOp {
...
ASCENDC_TPL_ARGS_DECL(
    Log, ASCENDC_TPL_UINT_DECL(schMode, 1, ASCENDC_TPL_UI_LIST, TPL_SCH_MODE_0, TPL_SCH_MODE_1),
...
#endif // CANN_CUSTOM_OPS_LOG_STRUCT_H_