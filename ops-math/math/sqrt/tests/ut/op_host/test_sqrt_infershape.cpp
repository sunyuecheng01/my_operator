...
TEST_F(SqrtInferShape, sqrt_infershape_test_0) {
...
TEST_F(SqrtInferShape, sqrt_infershape_test_1) {
    gert::InfershapeContextPara infershapeContextPara("Sqrt",
                                                      {
    ...
    std::vector<std::vector<int64_t>> expectOutputShape = {{3, 4, 5, 6, -1},};
    ExecuteTestCase(infershapeContextPara, ge::GRAPH_SUCCESS, expectOutputShape);
}

TEST_F(SqrtInferShape, sqrt_infershape_test_2) {
    gert::InfershapeContextPara infershapeContextPara("Sqrt",
                                                      {
...
TEST_F(SqrtInferShape, sqrt_infershape_test_3) {
    gert::InfershapeContextPara infershapeContextPara("Sqrt",
                                                      {
