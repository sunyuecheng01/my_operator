 ...
 * @domain aclnn_math
 */
ACLNN_API aclnnStatus aclnnReduceNansumGetWorkspaceSize(
...
aclnnReduceNansum(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, aclrtStream stream);
