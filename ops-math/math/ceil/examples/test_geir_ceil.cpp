...
#define ADD_INPUT(inputIndex, inputName, inputDtype, inputShape)                                                    \
    do {                                                                                                            \
        ...
        ceil1.set_input_##inputName(placeholder##inputIndex);                                                       \
...
#define ADD_OUTPUT(outputIndex, outputName, outputDtype, outputShape)                                           \
    do {                                                                                                        \
        ...
        ceil1.update_output_desc_##outputName(outputName##outputIndex##_desc);                                  \
    } while (0)
    ...
    Graph& graph)
{
    ...
    auto ceil1 = op::Ceil("ceil1");
    std::vector<int64_t> xShape = {4, 3}; // 与 cross 示例一致

    ADD_INPUT(1, x, inDtype, xShape);

    ADD_OUTPUT(1, y, inDtype, xShape);
    outputs.push_back(ceil1);
