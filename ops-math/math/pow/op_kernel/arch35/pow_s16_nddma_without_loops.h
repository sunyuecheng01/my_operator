...
/*!
 * \file pow_s16_nddma_without_loops.h
 * \brief
 */
#ifndef ASCENDC_POW_S16_NDDMA_WITHOUT_LOOPS_H_
#define ASCENDC_POW_S16_NDDMA_WITHOUT_LOOPS_H_
...
class PowS16NddmaWithoutLoops
{
public:
    __aicore__ inline PowS16NddmaWithoutLoops(){};
                                ...
                                const PowTensorTensorTilingData* tilingDataPtr, TPipe* pipePtr)
    {
        ...
        inputGmInputX_.SetGlobalBuffer((__gm__ int16_t*)inputX);
        inputGmInputY_.SetGlobalBuffer((__gm__ int16_t*)inputY);
        outputGmOutputZ_.SetGlobalBuffer((__gm__ int16_t*)outputZ);
        constexpr int64_t DOUBLE_BUFFER = 2;
        int64_t BUFFER_SIZE_0 = tilingDataPtr_->elemNum * sizeof(int16_t);
...
private:
    __aicore__ inline void CopyIn0(int64_t ubSplitSize, const int64_t (&axesIndices)[BROADCAST_MAX_DIMS],
                                   int64_t ubLoopIdx)
    {
        bufferIn0_ = queIn0_.AllocTensor<int16_t>();
                                   ...
                                   int64_t ubLoopIdx)
    {
        ...
        queIn1_.EnQue<int16_t>(bufferIn1_);
    }

    __aicore__ inline void Compute2(int64_t ubSplitSize, const int64_t (&axesIndices)[BROADCAST_MAX_DIMS],
                                    int64_t ubLoopIdx)
    {
        bufferIn0_ = queIn0_.DeQue<int16_t>();
        bufferIn1_ = queIn1_.DeQue<int16_t>();
        bufferOut0_ = queOut0_.AllocTensor<int16_t>();
        Power<int16_t, false, pConfig_>(bufferOut0_, bufferIn0_, bufferIn1_, 
        ...
        queOut0_.EnQue<int16_t>(bufferOut0_);
    }

    __aicore__ inline void CopyOut3(int64_t ubSplitSize, const int64_t (&axesIndices)[BROADCAST_MAX_DIMS],
                                    int64_t ubLoopIdx)
    {
        bufferOut0_ = queOut0_.DeQue<int16_t>();
        AscendC::DataCopyExtParams dataCopyExtParams;
        dataCopyExtParams.blockCount = 1;
        dataCopyExtParams.blockLen =
            ubSplitSize * tilingDataPtr_->outputStrides[tilingDataPtr_->ubSplitAxis] * sizeof(int16_t);
...
private:
    ...
    GlobalTensor<int16_t> inputGmInputX_;
    GlobalTensor<int16_t> inputGmInputY_;
    GlobalTensor<int16_t> outputGmOutputZ_;
    ...
    LocalTensor<int16_t> bufferIn0_;
    LocalTensor<int16_t> bufferIn1_;
    LocalTensor<int16_t> bufferOut0_;
    constexpr static PowerConfig pConfig_ = {PowerAlgo::INTRINSIC};
};

}  // namespace Pow
#endif  // ASCENDC_POW_S16_NDDMA_WITHOUT_LOOPS_H_
