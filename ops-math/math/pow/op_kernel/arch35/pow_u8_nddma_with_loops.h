...
/*!
 * \file pow_u8_nddma_with_loops.h
 * \brief
 */
#ifndef ASCENDC_POW_U8_NDDMA_WITH_LOOPS_H_
#define ASCENDC_POW_U8_NDDMA_WITH_LOOPS_H_
...
class PowU8NddmaWithLoops
{
public:
    __aicore__ inline PowU8NddmaWithLoops(){};
...
#endif  // ASCENDC_POW_U8_NDDMA_WITH_LOOPS_H_
