...
/*!
 * \file pow_s8_nddma_with_loops.h
 * \brief
 */
#ifndef ASCENDC_POW_S8_NDDMA_WITH_LOOPS_H_
#define ASCENDC_POW_S8_NDDMA_WITH_LOOPS_H_
...
class PowS8NddmaWithLoops
{
public:
    __aicore__ inline PowS8NddmaWithLoops(){};
...
#endif  // ASCENDC_POW_S8_NDDMA_WITH_LOOPS_H_
