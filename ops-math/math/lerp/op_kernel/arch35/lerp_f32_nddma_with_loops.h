...
/*!
 * \file lerp_f32_nddma_with_loops.h
 * \brief
 */
#ifndef ASCENDC_LERP_F32_NDDMA_WITH_LOOPS_H_
#define ASCENDC_LERP_F32_NDDMA_WITH_LOOPS_H_
...
class LerpF32NddmaWithLoops {
   public:
    __aicore__ inline LerpF32NddmaWithLoops(){};
...
#endif  // ASCENDC_LERP_F32_NDDMA_WITH_LOOPS_H_
