...
/*!
 * \file lerp_dtype_comb_1_nddma_with_loops.h
 * \brief
 */
#ifndef ASCENDC_LERP_DTYPE_COMB_1_NDDMA_WITH_LOOPS_H_
#define ASCENDC_LERP_DTYPE_COMB_1_NDDMA_WITH_LOOPS_H_
...
class LerpDtypeComb1NddmaWithLoops {
   public:
    __aicore__ inline LerpDtypeComb1NddmaWithLoops(){};
...
#endif  // ASCENDC_LERP_DTYPE_COMB_1_NDDMA_WITH_LOOPS_H_
