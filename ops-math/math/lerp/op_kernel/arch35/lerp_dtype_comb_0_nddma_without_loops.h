...
/*!
 * \file lerp_dtype_comb_0_nddma_without_loops.h
 * \brief
 */
#ifndef ASCENDC_LERP_DTYPE_COMB_0_NDDMA_WITHOUT_LOOPS_H_
#define ASCENDC_LERP_DTYPE_COMB_0_NDDMA_WITHOUT_LOOPS_H_
