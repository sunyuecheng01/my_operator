 ...
 * @domain aclnn_math
 */
ACLNN_API aclnnStatus aclnnAnyGetWorkspaceSize(
...
aclnnAny(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, const aclrtStream stream);

#ifdef __cplusplus
}
#endif

#endif // OP_API_INC_LEVEL2_ACLNN_ANY_H_