...
- **参数说明：**
  ...
  - self（aclTensor*, 计算输入）：公式中的输入`self`。shape支持0到8维，与out的数据类型需满足数据类型推导规则（参见[互推导关系](../../../docs/zh/context/互推导关系.md)），支持[非连续的Tensor](../../../docs/zh/context/非连续的Tensor.md)，[数据格式](../../../docs/zh/context/数据格式.md)支持ND。
  ...
  - out（aclTensor*, 计算输出）：公式中的输出`out`。shape支持0到8维，self与out的shape满足计算公式中的推导规则，与self的数据类型需满足数据类型推导规则（参见[互推导关系](../../../docs/zh/context/互推导关系.md)），支持[非连续的Tensor](../../../docs/zh/context/非连续的Tensor.md)，[数据格式](../../../docs/zh/context/数据格式.md)支持ND。
