...
#include "nn_other.h"
#include "../op_graph/add_n_proto.h"
...
#define ADD_DYNAMIC_INPUT(inputIndex, inputDtype, inputShape, dataName)                                     \
    do {                                                                                                    \
        ...
        addN.UpdateDynamicInputDesc("x", inputIndex, desc##dataName);                                       \
        addN.set_dynamic_input_x(inputIndex, placeholder##dataName);                                        \
