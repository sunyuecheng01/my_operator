...
/*!
 * \file tanh_grad_dtype_comb_4_nddma_with_loops.h
 * \brief
 */
#ifndef ASCENDC_TANH_GRAD_DTYPE_COMB_4_NDDMA_WITH_LOOPS_H_
#define ASCENDC_TANH_GRAD_DTYPE_COMB_4_NDDMA_WITH_LOOPS_H_
...
class TanhGradDtypeComb4NddmaWithLoops {
public:
    __aicore__ inline TanhGradDtypeComb4NddmaWithLoops(){};
...
#endif // ASCENDC_TANH_GRAD_DTYPE_COMB_4_NDDMA_WITH_LOOPS_H_
