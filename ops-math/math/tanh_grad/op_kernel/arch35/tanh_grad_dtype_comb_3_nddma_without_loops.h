...
/*!
 * \file tanh_grad_dtype_comb_3_nddma_without_loops.h
 * \brief
 */
#ifndef ASCENDC_TANH_GRAD_DTYPE_COMB_3_NDDMA_WITHOUT_LOOPS_H_
#define ASCENDC_TANH_GRAD_DTYPE_COMB_3_NDDMA_WITHOUT_LOOPS_H_
...
class TanhGradDtypeComb3NddmaWithoutLoops {
public:
    __aicore__ inline TanhGradDtypeComb3NddmaWithoutLoops(){};
...
#endif // ASCENDC_TANH_GRAD_DTYPE_COMB_3_NDDMA_WITHOUT_LOOPS_H_
