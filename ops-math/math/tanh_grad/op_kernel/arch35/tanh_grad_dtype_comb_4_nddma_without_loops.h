...
/*!
 * \file tanh_grad_dtype_comb_4_nddma_without_loops.h
 * \brief
 */
#ifndef ASCENDC_TANH_GRAD_DTYPE_COMB_4_NDDMA_WITHOUT_LOOPS_H_
#define ASCENDC_TANH_GRAD_DTYPE_COMB_4_NDDMA_WITHOUT_LOOPS_H_
...
class TanhGradDtypeComb4NddmaWithoutLoops {
public:
    __aicore__ inline TanhGradDtypeComb4NddmaWithoutLoops(){};
...
#endif // ASCENDC_TANH_GRAD_DTYPE_COMB_4_NDDMA_WITHOUT_LOOPS_H_
