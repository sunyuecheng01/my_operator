...
/*!
 * \file tanh_grad_f32_nddma_without_loops.h
 * \brief
 */
#ifndef ASCENDC_TANH_GRAD_F32_NDDMA_WITHOUT_LOOPS_H_
#define ASCENDC_TANH_GRAD_F32_NDDMA_WITHOUT_LOOPS_H_
...
class TanhGradF32NddmaWithoutLoops {
public:
    __aicore__ inline TanhGradF32NddmaWithoutLoops(){};
        ...
        int64_t ubSplitSize, const int64_t (&axesIndices)[Ops::Base::BROADCAST_MAX_DIMS], int64_t ubLoopIdx)
    {
        ...
        __VEC_SCOPE__
        {
            ...
            for (uint16_t i = 0; i < vfLoopNum; i++) {
                ...
                AscendC::MicroAPI::Mul<float, AscendC::MicroAPI::MaskMergeMode::ZEROING>(vreg5, vreg3, vreg4, preg0);
                AscendC::MicroAPI::DataCopy<float, AscendC::MicroAPI::StoreDist::DIST_NORM_B32>(
                    bufferOut0Addr + i * (AscendC::VECTOR_REG_WIDTH / 4), vreg5, preg0);
            }
        }
...
#endif // ASCENDC_TANH_GRAD_F32_NDDMA_WITHOUT_LOOPS_H_
