...
/*!
 * \file tanh_grad_dtype_comb_1_nddma_with_loops.h
 * \brief
 */
#ifndef ASCENDC_TANH_GRAD_DTYPE_COMB_1_NDDMA_WITH_LOOPS_H_
#define ASCENDC_TANH_GRAD_DTYPE_COMB_1_NDDMA_WITH_LOOPS_H_
...
class TanhGradDtypeComb1NddmaWithLoops {
public:
    __aicore__ inline TanhGradDtypeComb1NddmaWithLoops(){};
...
#endif // ASCENDC_TANH_GRAD_DTYPE_COMB_1_NDDMA_WITH_LOOPS_H_
