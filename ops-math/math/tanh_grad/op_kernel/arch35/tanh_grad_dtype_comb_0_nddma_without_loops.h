...
/*!
 * \file tanh_grad_dtype_comb_0_nddma_without_loops.h
 * \brief
 */
#ifndef ASCENDC_TANH_GRAD_DTYPE_COMB_0_NDDMA_WITHOUT_LOOPS_H_
#define ASCENDC_TANH_GRAD_DTYPE_COMB_0_NDDMA_WITHOUT_LOOPS_H_
...
class TanhGradDtypeComb0NddmaWithoutLoops {
public:
    __aicore__ inline TanhGradDtypeComb0NddmaWithoutLoops(){};
...
#endif // ASCENDC_TANH_GRAD_DTYPE_COMB_0_NDDMA_WITHOUT_LOOPS_H_
