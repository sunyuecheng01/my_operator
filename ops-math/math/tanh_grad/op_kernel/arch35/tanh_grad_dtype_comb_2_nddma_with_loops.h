...
/*!
 * \file tanh_grad_dtype_comb_2_nddma_with_loops.h
 * \brief
 */
#ifndef ASCENDC_TANH_GRAD_DTYPE_COMB_2_NDDMA_WITH_LOOPS_H_
#define ASCENDC_TANH_GRAD_DTYPE_COMB_2_NDDMA_WITH_LOOPS_H_
...
class TanhGradDtypeComb2NddmaWithLoops {
public:
    __aicore__ inline TanhGradDtypeComb2NddmaWithLoops(){};
...
#endif // ASCENDC_TANH_GRAD_DTYPE_COMB_2_NDDMA_WITH_LOOPS_H_
