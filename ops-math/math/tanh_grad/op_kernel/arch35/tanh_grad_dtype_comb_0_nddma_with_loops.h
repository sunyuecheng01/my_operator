...
/*!
 * \file tanh_grad_dtype_comb_0_nddma_with_loops.h
 * \brief
 */
#ifndef ASCENDC_TANH_GRAD_DTYPE_COMB_0_NDDMA_WITH_LOOPS_H_
#define ASCENDC_TANH_GRAD_DTYPE_COMB_0_NDDMA_WITH_LOOPS_H_
...
class TanhGradDtypeComb0NddmaWithLoops {
public:
    __aicore__ inline TanhGradDtypeComb0NddmaWithLoops(){};
...
#endif // ASCENDC_TANH_GRAD_DTYPE_COMB_0_NDDMA_WITH_LOOPS_H_
