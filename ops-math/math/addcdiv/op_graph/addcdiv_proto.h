...
/*!
 * \file addcdiv_proto.h
 * \brief
 */
#ifndef OPS_OP_PROTO_INC_ADDCDIV_H_
#define OPS_OP_PROTO_INC_ADDCDIV_H_
...
* @li input_data: A ND mutable input tensor. Must be one of the following types:
*     float16, bfloat16, float32, double, int64.
* @li x1: A ND mutable input tensor of the same dtype as input_data.
* @li x2: A ND mutable input tensor of the same dtype as input_data.
...
#endif // OPS_OP_PROTO_INC_ADDCDIV_H_
