...
class l2_abs_test : public testing::Test {
  protected:
    static void SetUpTestCase() { cout << "abs_test SetUp" << endl; }

    static void TearDownTestCase() { cout << "abs_test TearDown" << endl; }
};
...
// test aicpu type: INT64, in fact tf mode
