...
class l2_bitwise_or_scalar_test : public testing::Test {
 protected:
  static void SetUpTestCase() {
    cout << "bitwise_or_scalar_test SetUp" << endl;
  }

  static void TearDownTestCase() { cout << "bitwise_or_scalar_test TearDown" << endl; }
};

// 正常场景_BOOL_ND
TEST_F(l2_bitwise_or_scalar_test, l2_bitwise_or_scalar_normal_BOOL_ND) {
...
// 正常场景_INT16_NHWC
TEST_F(l2_bitwise_or_scalar_test, l2_bitwise_or_scalar_normal_INT16_NHWC) {
...
// 正常场景_INT32_HWCN
TEST_F(l2_bitwise_or_scalar_test, l2_bitwise_or_scalar_normal_INT32_HWCN) {
...
// 正常场景_INT64_NDHWC
TEST_F(l2_bitwise_or_scalar_test, l2_bitwise_or_scalar_normal_INT64_NDHWC) {
...
// 空tensor场景
TEST_F(l2_bitwise_or_scalar_test, l2_bitwise_or_scalar_normal_empty_tensor) {
...
TEST_F(l2_bitwise_or_scalar_test, l2_bitwise_or_scalar_abnormal_self_nullptr) {
...
TEST_F(l2_bitwise_or_scalar_test, l2_bitwise_or_scalar_abnormal_other_nullptr) {
...
TEST_F(l2_bitwise_or_scalar_test, l2_bitwise_or_scalar_abnormal_out_nullptr) {
  auto selfDesc = TensorDesc({2}, ACL_INT32, ACL_FORMAT_ND);
  int32_t value = 1;
  auto otherDesc = ScalarDesc(value);
...
TEST_F(l2_bitwise_or_scalar_test, l2_bitwise_or_scalar_abnormal_self_BF16) {
...
TEST_F(l2_bitwise_or_scalar_test, l2_bitwise_or_scalar_abnormal_self_FLOAT) {
...
TEST_F(l2_bitwise_or_scalar_test, l2_bitwise_or_scalar_abnormal_self_FLOAT16) {
...
TEST_F(l2_bitwise_or_scalar_test, l2_bitwise_or_scalar_abnormal_self_DOUBLE) {
...
TEST_F(l2_bitwise_or_scalar_test, l2_bitwise_or_scalar_abnormal_self_COMPLEX64) {
...
TEST_F(l2_bitwise_or_scalar_test, l2_bitwise_or_scalar_abnormal_self_COMPLEX128) {
...
TEST_F(l2_bitwise_or_scalar_test, l2_bitwise_or_scalar_abnormal_dtype_UNDEFINED) {
...
TEST_F(l2_bitwise_or_scalar_test, l2_bitwise_or_scalar_abnormal_other_FLOAT) {
  auto selfDesc = TensorDesc({2}, ACL_INT32, ACL_FORMAT_ND);
  float value = 1.0;
  auto otherDesc = ScalarDesc(value);
  auto outDesc = TensorDesc({2}, ACL_INT32, ACL_FORMAT_ND);
...
TEST_F(l2_bitwise_or_scalar_test, l2_bitwise_or_scalar_normal_dtype_unequal) {
  auto selfDesc = TensorDesc({2}, ACL_BOOL, ACL_FORMAT_ND);
  int64_t value = 1;
  auto otherDesc = ScalarDesc(value);
...
TEST_F(l2_bitwise_or_scalar_test, l2_bitwise_or_scalar_normal_dtype_can_cast) {
...
TEST_F(l2_bitwise_or_scalar_test, l2_bitwise_or_scalar_abnormal_dtype_cannot_cast) {
  auto selfDesc = TensorDesc({2}, ACL_INT32, ACL_FORMAT_ND);
  int32_t value = 1;
  auto otherDesc = ScalarDesc(value);
  auto outDesc = TensorDesc({2}, ACL_BOOL, ACL_FORMAT_ND);
...
// CheckShape_unequal
TEST_F(l2_bitwise_or_scalar_test, l2_bitwise_or_scalar_abnormal_shape_unequal) {
...
// CheckShape_10D
TEST_F(l2_bitwise_or_scalar_test, l2_bitwise_or_scalar_abnormal_shape_10D) {
...
// 数据范围[-1，1]
TEST_F(l2_bitwise_or_scalar_test, l2_bitwise_or_scalar_normal_valuerange) {
...
// 非连续
TEST_F(l2_bitwise_or_scalar_test, l2_bitwise_or_scalar_normal_uncontiguous) {
...
TEST_F(l2_bitwise_or_scalar_test, ascend910B2_l2_bitwise_or_scalar_normal_INT64_NDHWC) {
  auto selfDesc = TensorDesc({2, 2, 2, 2, 2}, ACL_INT64, ACL_FORMAT_NDHWC);
  int64_t value = 1;
  auto otherDesc = ScalarDesc(value);
  auto outDesc = TensorDesc({2, 2, 2, 2, 2}, ACL_INT64, ACL_FORMAT_NDHWC);
