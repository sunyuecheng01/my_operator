...
#include "../../../../op_host/op_api/aclnn_logaddexp.h"
...
class l2_logaddexp_test : public testing::Test {
 protected:
  static void SetUpTestCase() {
    cout << "logaddexp_test SetUp" << endl;
  }

  static void TearDownTestCase() {
    cout << "logaddexp_test TearDown" << endl;
  }
};

TEST_F(l2_logaddexp_test, case_nullptr_input) {
...
TEST_F(l2_logaddexp_test, case_nullptr_output) {
  ...
  auto ut = OP_API_UT(aclnnLogAddExp, INPUT(self_tensor_desc, other_tensor_desc), OUTPUT((aclTensor*)nullptr));
...
TEST_F(l2_logaddexp_test, case_dtype_notsupport) {
  ...
  auto out_tensor_desc = TensorDesc({2, 3, 4, 5}, ACL_INT32, ACL_FORMAT_NHWC);

  auto ut = OP_API_UT(aclnnLogAddExp, INPUT(self_tensor_desc, other_tensor_desc), OUTPUT(out_tensor_desc));
...
TEST_F(l2_logaddexp_test, case_dtype_input_int_out_fp) {
...
TEST_F(l2_logaddexp_test, case_dtype_input_bool_out_fp) {
...
TEST_F(l2_logaddexp_test, case_dtype_fp32) {
  auto self_tensor_desc = TensorDesc({2, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
  auto other_tensor_desc = TensorDesc({2, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
...
TEST_F(l2_logaddexp_test, case_dtype_fp16) {
...
TEST_F(l2_logaddexp_test, case_dtype_double) {
...
TEST_F(l2_logaddexp_test, case_format_HWCN) {
...
TEST_F(l2_logaddexp_test, case_format_NDHWC) {
...
TEST_F(l2_logaddexp_test, case_format_NCDHW) {
...
TEST_F(l2_logaddexp_test, case_promoteType_ok) {
  ...
  auto out_tensor_desc = TensorDesc({2, 3, 4, 5}, ACL_FLOAT, ACL_FORMAT_ND).Precision(0.001, 0.001);
...
TEST_F(l2_logaddexp_test, case_promoteType_nok) {
  auto self_tensor_desc = TensorDesc({2, 3, 4, 5}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(-2, 2);
  auto other_tensor_desc = TensorDesc({2, 3, 4, 5}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
  auto out_tensor_desc = TensorDesc({2, 3, 4, 5}, ACL_INT32, ACL_FORMAT_ND).Precision(0.001, 0.001);
...
TEST_F(l2_logaddexp_test, case_invalid_shape) {
  ...
  auto out_tensor_desc = TensorDesc({1, 1, 1, 3}, ACL_FLOAT, ACL_FORMAT_ND).Precision(0.001, 0.001);
...
TEST_F(l2_logaddexp_test, case_broadcast_ok) {
...
TEST_F(l2_logaddexp_test, case_broadcast_nok) {
  auto self_tensor_desc = TensorDesc({2, 3, 4, 5}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
...
TEST_F(l2_logaddexp_test, case_dim_1) {
...
TEST_F(l2_logaddexp_test, case_dim_3) {
...
TEST_F(l2_logaddexp_test, case_dim_4) {
...
TEST_F(l2_logaddexp_test, case_dim_8) {
...
TEST_F(l2_logaddexp_test, case_dim_9) {
...
TEST_F(l2_logaddexp_test, case_empty_empty_empty) {
  ...
  auto out_tensor_desc = TensorDesc({0, 2, 0}, ACL_FLOAT, ACL_FORMAT_ND).Precision(0.001, 0.001);
...
TEST_F(l2_logaddexp_test, case_empty_noempty_empty) {
  auto self_tensor_desc = TensorDesc({1, 2, 0}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(-2, 2);
  auto other_tensor_desc = TensorDesc({1, 2, 1}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(-2, 2);
  auto out_tensor_desc = TensorDesc({1, 2, 0}, ACL_FLOAT, ACL_FORMAT_ND).Precision(0.001, 0.001);
...
TEST_F(l2_logaddexp_test, case_noempty_empty_empty) {
  auto self_tensor_desc = TensorDesc({1, 2, 1}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
  auto other_tensor_desc = TensorDesc({0, 2, 1}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
  auto out_tensor_desc = TensorDesc({0, 2, 1}, ACL_FLOAT16, ACL_FORMAT_ND).Precision(0.001, 0.001);
...
TEST_F(l2_logaddexp_test, case_noempty_noempty_empty) {
  auto self_tensor_desc = TensorDesc({1, 2, 1}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
  auto other_tensor_desc = TensorDesc({1, 2, 1}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
  auto out_tensor_desc = TensorDesc({0, 2, 1}, ACL_FLOAT, ACL_FORMAT_ND).Precision(0.001, 0.001);
...
TEST_F(l2_logaddexp_test, case_empty_empty_noempty) {
  ...
  auto out_tensor_desc = TensorDesc({1, 2, 1}, ACL_FLOAT, ACL_FORMAT_ND).Precision(0.001, 0.001);
...
TEST_F(l2_logaddexp_test, case_noempty_empty_noempty) {
  auto self_tensor_desc = TensorDesc({1, 2, 1}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
  auto other_tensor_desc = TensorDesc({1, 2, 0}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
  auto out_tensor_desc = TensorDesc({1, 2, 1}, ACL_FLOAT, ACL_FORMAT_ND).Precision(0.001, 0.001);
...
TEST_F(l2_logaddexp_test, case_empty_noempty_noempty) {
  auto self_tensor_desc = TensorDesc({1, 2, 0}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
  auto other_tensor_desc = TensorDesc({1, 2, 1}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
  auto out_tensor_desc = TensorDesc({1, 2, 1}, ACL_FLOAT, ACL_FORMAT_ND).Precision(0.001, 0.001);
