...
#include "../../../../op_host/op_api/aclnn_max.h"
...
class l2_max_test : public testing::Test {
  protected:
  static void SetUpTestCase() { cout << "max_test SetUp" << endl; }

  static void TearDownTestCase() { cout << "max_test TearDown" << endl; }
};

TEST_F(l2_max_test, case_000_workspace) {
  ...
  auto ut = OP_API_UT(aclnnMax, INPUT(selfTensor), OUTPUT(outTensor));
...
TEST_F(l2_max_test, case_001_float32_normal) {
  auto selfTensor = TensorDesc({3, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-10, 10);
  auto outTensor = TensorDesc({1}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_max_test, case_002_float16_normal) {
...
TEST_F(l2_max_test, case_003_int32_normal) {
...
TEST_F(l2_max_test, case_004_double_normal) {
...
TEST_F(l2_max_test, case_005_int8_normal) {
...
TEST_F(l2_max_test, case_007_uint8_normal) {
...
TEST_F(l2_max_test, case_008_int16_normal) {
...
TEST_F(l2_max_test, case_009_int64_normal) {
...
TEST_F(l2_max_test, case_010_1_dim_input_tensor) {
...
TEST_F(l2_max_test, case_011_3_dim_input_tensor) {
...
TEST_F(l2_max_test, case_012_5_dim_input_tensor) {
...
TEST_F(l2_max_test, case_013_8_dim_input_tensor) {
...
TEST_F(l2_max_test, case_015_NHWC) {
...
TEST_F(l2_max_test, case_016_NCHW) {
...
TEST_F(l2_max_test, case_017_HWCN) {
...
TEST_F(l2_max_test, case_018_NDHWC) {
...
TEST_F(l2_max_test, case_019_NCDHW) {
...
TEST_F(l2_max_test, case_022_empty_tensor) {
...
TEST_F(l2_max_test, case_024_uncontiguous) {
...
TEST_F(l2_max_test, case_024_nullptr) {
  auto selfTensor = TensorDesc({2, 3, 4, 5}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-10, 10);
  auto outTensor = TensorDesc({1}, ACL_FLOAT, ACL_FORMAT_ND);

  auto ut1 = OP_API_UT(aclnnMax, INPUT((aclTensor *)nullptr), OUTPUT(outTensor));
  uint64_t workspaceSize = 0;
  aclnnStatus aclRet = ut1.TestGetWorkspaceSize(&workspaceSize);
  EXPECT_EQ(aclRet, ACLNN_ERR_PARAM_NULLPTR);

  auto ut2 = OP_API_UT(aclnnMax, INPUT(selfTensor), OUTPUT((aclTensor *)nullptr));
  workspaceSize = 0;
  aclRet = ut2.TestGetWorkspaceSize(&workspaceSize);
  EXPECT_EQ(aclRet, ACLNN_ERR_PARAM_NULLPTR);
}

TEST_F(l2_max_test, case_025_9_dim_input_tensor) {
...
TEST_F(l2_max_test, case_026_bool_normal) {
...
// Ascend910B2 支持bf16
TEST_F(l2_max_test, ascend910B2_case_027_bf16_910b) {
...
// Ascend910 不支持bf16
TEST_F(l2_max_test, case_028_bf16_910) {
  auto selfTensor = TensorDesc({3, 3}, ACL_BF16, ACL_FORMAT_ND).ValueRange(-10, 10);
  auto outTensor = TensorDesc({1}, ACL_BF16, ACL_FORMAT_ND);
