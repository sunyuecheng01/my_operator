 ...
 * \brief
 */
#ifndef CANN_CUSTOM_OPS_IS_NAN_DAG_H
#define CANN_CUSTOM_OPS_IS_NAN_DAG_H
...
struct IsNanDAG {
    ...
    using CompareMask = Bind<Vec::Compare<uint8_t, U, CMP_MODE>, OpCopyIn, OpCopyIn>;
    using SelectRes = Bind<Vec::Select<uint8_t, uint8_t, SELECT_MODE>, CompareMask, DataZero, ConstOne>;
...
#endif // CANN_CUSTOM_OPS_IS_NAN_DAG_H