...
const std::string ktestcaseFilePath =
    "../../../../math/equal/tests/ut/op_kernel_aicpu/";
...
template <typename T>
void EqualBroadcast(vector<string> data_files, DataType dtype0, DataType dtype1, DataType output_dtype,
...
TEST_F(TEST_EQUAL_UT, TestEqual_int32_int32_broadcast1) {
    vector<string> files{
        "equal/data/broadcast1_equal_data_int32_input1.txt",
    ...
    EqualBroadcast<int32_t>(files, DT_INT32, DT_INT32, DT_BOOL, shapes);
}

TEST_F(TEST_EQUAL_UT, TestEqual_int32_int32_broadcast2) {
    vector<string> files{
        "equal/data/broadcast2_equal_data_int32_input1.txt",
...
TEST_F(TEST_EQUAL_UT, TestEqual_int32_int32_broadcast3) {
    vector<string> files{
        "equal/data/broadcast3_equal_data_int32_input1.txt",
