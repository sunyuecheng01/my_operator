...
/*!
 * \file sqrt_grad_struct.h
 * \brief
 */

#include "ascendc/host_api/tiling/template_argument.h"
#ifndef CANN_CUSTOM_OPS_SQRT_GRAD_STRUCT_H_
#define CANN_CUSTOM_OPS_SQRT_GRAD_STRUCT_H_
...
ASCENDC_TPL_ARGS_DECL(
    SqrtGrad, ASCENDC_TPL_UINT_DECL(schMode, 1, ASCENDC_TPL_UI_LIST, TPL_SCH_MODE_0, TPL_SCH_MODE_1),
...
#endif // CANN_CUSTOM_OPS_SQRT_GRAD_STRUCT_H_