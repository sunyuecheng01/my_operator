...
class Minimum : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "Minimum SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "Minimum TearDown" << std::endl;
  }
};
    ...
    ge::graphStatus testCaseResult = ge::GRAPH_SUCCESS)
{
    ...
    auto inferShapeFunc = spaceRegistry->GetOpImpl("Minimum")->infer_shape;
...
TEST_F(Minimum, minimum_infershape_case_0)
{
