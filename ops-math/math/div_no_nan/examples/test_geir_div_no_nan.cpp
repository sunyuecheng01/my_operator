...
#include "nn_other.h"
#include "../op_graph/div_no_nan_proto.h"
...
#define ADD_INPUT(intputIndex, intputName, intputDtype, inputShape)                                                 \
    do {                                                                                                            \
        ...
        div_no_nan1.set_input_##intputName(placeholder##intputIndex);                                               \
