...
#ifndef OP_API_INC_LEVEL0_OP_ARGMIN_WITH_VALUE_OP_H_
#define OP_API_INC_LEVEL0_OP_ARGMIN_WITH_VALUE_OP_H_
...
#endif // OP_API_INC_LEVEL0_OP_ARGMIN_WITH_VALUE_OP_H_
