 ...
 * \brief
 */
#ifndef ASCENDC_FLOOR_F16_H_
#define ASCENDC_FLOOR_F16_H_

#include "kernel_operator.h"

const uint16_t FP16_SIGN1 = 0x8000;
const uint16_t FP16_SIGN2 = 0x7FFF;
namespace Floor {
    ...
    __aicore__ inline void Compute1(int64_t i0Extent, int64_t ubLoopIdx)
    {
        ...
        __VEC_SCOPE__
        {
            ...
            for (uint16_t i = 0; i < vfLoopNum; i++) {
                preg0 = AscendC::MicroAPI::UpdateMask<half>(size);
                AscendC::MicroAPI::DataCopy<half, AscendC::MicroAPI::LoadDist::DIST_NORM>(
                    vreg0, bufferIn0Addr + i * (AscendC::VECTOR_REG_WIDTH / sizeof(half)));
                AscendC::MicroAPI::Truncate<
                    half, AscendC::RoundMode::CAST_FLOOR, AscendC::MicroAPI::MaskMergeMode::ZEROING>(
                    vreg1, vreg0, preg0);
                AscendC::MicroAPI::Duplicate(vreg2, FP16_SIGN1, preg0);
                AscendC::MicroAPI::Duplicate(vreg3, FP16_SIGN2, preg0);
                ...
                AscendC::MicroAPI::DataCopy<half, AscendC::MicroAPI::StoreDist::DIST_NORM_B16>(
                    bufferOut0Addr + i * (AscendC::VECTOR_REG_WIDTH / sizeof(half)), (RegTensor<half>&)vreg3, preg0);
            }
        }
