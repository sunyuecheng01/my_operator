...
class random_standard_normal_v2 : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "random_standard_normal_v2 SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "random_standard_normal_v2 TearDown" << std::endl;
    }
};
    ...
    ge::graphStatus testCaseResult = ge::GRAPH_SUCCESS)
{
    ...
    auto contextHolder = gert::InferShapeContextFaker()
                             .SetOpType("RandomStandardNormalV2")
                             .NodeIoNum(2, 2)
    ...
    auto inferShapeFunc = spaceRegistry->GetOpImpl("RandomStandardNormalV2")->infer_shape;
...
TEST_F(random_standard_normal_v2, random_standard_normal_v2_infershape_case_0)
{
