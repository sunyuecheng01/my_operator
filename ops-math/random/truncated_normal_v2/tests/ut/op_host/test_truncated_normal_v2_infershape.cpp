...
class truncated_normal_v2 : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "truncated_normal_v2 SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "truncated_normal_v2 TearDown" << std::endl;
    }
};
    ...
    ge::graphStatus testCaseResult = ge::GRAPH_SUCCESS)
{
    ...
    auto inferShapeFunc = spaceRegistry->GetOpImpl("TruncatedNormalV2")->infer_shape;
...
TEST_F(truncated_normal_v2, truncated_normal_v2_infershape_case_0)
{
