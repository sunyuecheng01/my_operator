...
"""
    ...
    def analyze_ops_files(self):
        ...
        for json_path in self._ops_info:
            if json_path.name == "binary_info_config.json":
                continue
    ...
    def _analyze_ops_l0op(self):
        opapi_symbol = self._build_dir / "opapi_math.txt"
    ...
    def _analyze_symbols(self):
        ophost_symbol = self._build_dir / "ophost_math.txt"
