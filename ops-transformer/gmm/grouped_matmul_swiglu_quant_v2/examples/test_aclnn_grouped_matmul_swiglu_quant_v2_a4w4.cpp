...
/*!
 * \file test_aclnn_grouped_matmul_swiglu_quant_v2_a4w4.cpp
 * \brief
 */
...
int main() {
    ...
    // 创建x aclTensor
    ret = CreateAclTensor(xHostData, xShape, &xDeviceAddr, aclDataType::ACL_INT32, aclFormat::ACL_FORMAT_ND, &x);
    CHECK_RET(ret == ACL_SUCCESS, return ret);
